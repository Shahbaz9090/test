                                ...
                                <?php } ?>
                                    ...
                                    <?php if($iterat_arr[$k]->type == 'input'){ ?>
                                        ...
                                        <div class="span6" id="<?=$key?>">
                                            ...
                                            <div class="span7">
                                                ...
                                                <?php } else{ ?>
                                                    <input <?=isset($iterat_arr[$k]->required) && $iterat_arr[$k]->required == 'true'?'required':''?> type="text" name="<?php echo $iterat_arr[$k]->name ?>" id="<?php echo $iterat_arr[$k]->name ?>" value="<?php echo isset($data_list[$cols->name])?$data_list[$cols->name]:'' ?>" class="span12 <?=$class_name_dynamic_unq;?>" <?=$class_name_dynamic;?> >
                                                <?php } ?>
                                    ...
                                    <?php } else if($iterat_arr[$k]->type == 'select'){
                                        ...
                                        if(isset($iterat_arr[$k]->option_type) && $iterat_arr[$k]->option_type=='table')
                                        {
                                            ...
                                            <div class="span6" id ="<?=$key?>">
                                                ...
                                                <div class="span7">
                                                    <select <?=isset($iterat_arr[$k]->required) && $iterat_arr[$k]->required == 'true'?'required':''?> name="<?php echo $iterat_arr[$k]->name ?>" class="span12">
                                                        <option value="">Select <?php echo ucwords($iterat_arr[$k]->label) ?></option>
                                                        <?php
                                    ...
                                    <?php }  else if($iterat_arr[$k]->type == 'multiselect'){
                                        if(isset($iterat_arr[$k]->option_type) && $iterat_arr[$k]->option_type=='table')
                                        {
                                            ...
                                            <div class="span6" id ="<?=$key?>">
                                                ...
                                                <div class="span7">
                                                    <select <?=isset($iterat_arr[$k]->required) && $iterat_arr[$k]->required == 'true'?'required':''?> multiple="" name="<?php echo $iterat_arr[$k]->name ?>[]" class="span12 multiselect1 <?php echo $iterat_arr[$k]->name ?>">
                                    ...
                                    <?php } else if($iterat_arr[$k]->type == 'calendar'){ ?>
                                        ...
                                        <div class="span6" id="<?=$key?>">
                                            ...
                                            <div class="span7">
                                                <input <?=isset($iterat_arr[$k]->required) && $iterat_arr[$k]->required == 'true'?'required':''?> readonly="" class="<?php echo $iterat_arr[$k]->name ?> span12" type="text" name="<?php echo $iterat_arr[$k]->name ?>" id="<?php echo $iterat_arr[$k]->name ?>" value="<?php echo isset($data_list[$cols->name]) && strtotime($data_list[$cols->name])?date('d/m/Y h:i:s',strtotime($data_list[$cols->name])):'' ?>">
                                                <div class="error" id="error_field_label"><?php echo form_error('field_label');?></div>
                                            </div>
                                        </div>
                                        <script type="text/javascript">
