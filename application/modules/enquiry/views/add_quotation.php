                    ...
                    <div class="portlet-body" style="padding: 5px;">
                                ...
                                <div class="span7">
                                    <select class="span12 nostyle chosen-select" name="supplier" id="supplier" required="">
                                        ...
                                        foreach ($supplier_master as $key => $supplier) {?>
                                            <option value="<?php echo $supplier->id ?>" data-vendor_type="<?php echo $supplier->vendor_type ?>"><?php echo $supplier->supplier_name ?></option>
                                        <?php }
                                        }?> -->
                                    </select>
                        ...
                        <div class="form-row row-fluid m-b-10">
                            <div class="span6">
                                ...
                                <div class="span7">
                                    <input required="" class="gw span12 text" type="text" name="gw" id="gw" value="">
                    ...
                    <div class="row-fluid" style="margin-bottom:10px;">
                        <div class="span12">
                            <div class="form-actions">
                                ...
                                <button type="submit" onclick="return confirm('Are you sure?')" class="btn  btn-info"> Add</button>
