                    ...
                    <div class="portlet-body" style="padding: 5px;">
                        ...
                        <div class="form-row row-fluid m-b-10" id="5">
                            ...
                            <div class="span6" id="4">
                                ...
                                <div class="span7">
                                    <input required="" oninput="this.value=this.value.replace(/[^0-9]/,'')" class="qty span12 text" type="text" name="qty" id="qty" value="<?php echo $product_list->qty ?>">
                                        ...
                                        <?php 
                                            if(isset($unit_master) && !empty($unit_master))
                                            {
                                                foreach ($unit_master as $key => $unit) {?>
                                                    ...
                                                    <option <?php echo isset($product_list->uom) && $product_list->uom==$unit->form_id?'selected':'' ?> value="<?php echo $unit->form_id ?>"><?php echo $unit->unit_name ?></option>
