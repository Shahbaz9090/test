			...
			<?php echo get_flashdata();?>
				<div class="box">
					<div class="title">
						<h4>
							<span><?=$title;?></span>
							<?php if(isset($po_id) && !empty($po_id)):?>
								<a href="<?=$order_url."/view/".$po_id?>">
									<span class="text-right" style="float: right;margin-right: 15px;color: white;"><?=$order_title;?></span>
								</a> 
							<?php endif;?>
						</h4>
					</div>
					<ul class="nav nav-tabs sticky">
					    ...
					    <li><a data-id="transalation" class="action-scroll-btn" href="?#transalation"><i class="ace-icon fa fa-compress align-top bigger-125"></i> Transalation</a></li>
					    <li><a data-id="offer" class="action-scroll-btn" href="?#offer"><i class="ace-icon fa fa-cut align-top bigger-125"></i> Offer</a></li>
					    <li><a data-id="price-calc" class="action-scroll-btn" href="?#price-calc"><i class="ace-icon fa fa-money align-top bigger-125"></i> Price Calc</a></li>
				  	</ul>
					...
					<div class="content">
							...
							<div class="form-row row-fluid">
								...
								<div class="master-container overflow-box1">
									<table class="responsive table table-bordered">
										...
										<!-- <tbody>
											...
											$i = 1;?>
										  	<tr>
												...
												<td style="text-align: left;"><?php echo isset($row->from_client) && strtotime($row->from_client)?date('d/m/Y',strtotime($row->from_client)):'--/--/----' ?></td>
												...
												<td style="text-align: left;"><?php echo isset($row->to_cfit) && strtotime($row->to_cfit)?date('d/m/Y',strtotime($row->to_cfit)):'--/--/----' ?></td>
												<td style="text-align: left;"><?php echo isset($row->from_cfit) && strtotime($row->from_cfit)?date('d/m/Y',strtotime($row->from_cfit)):'--/--/----' ?></td>
												<td style="text-align: left;"><?php echo isset($row->to_client) && strtotime($row->to_client)?date('d/m/Y',strtotime($row->to_client)):'--/--/----' ?></td>
										  	</tr>
										  	<?php
											}else{
                                        ...
                                        <tbody>
                                            <tr>
                                                <th style="background: transparent;">Inq No.</th>
                                                <td style="text-align: left;"><?php echo $row->enq_no; ?></td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: left;"><?php echo $row->client_address; ?></td>
                                                <td></td><td></td>
                                            </tr>
                                            <tr>
                                                <th>Issuer Name</th>
                                                <!-- <td style="text-align: left;"><?php echo $row->client_issuer_name; ?></td> -->
                                                <td colspan="3" style="text-align: left;"><a target="_blank" href="<?=base_url('company/contact/view/'.$row->issuer_name)?>"><?php echo $row->client_issuer_name; ?></a></td>
                                                
                                            </tr>
                                            <?php 
                                            if(isset($client_contact_list) && !empty($client_contact_list))
                                            {
                                                $indxx = 1;
                                                foreach ($client_contact_list as $client_contact_key => $client_contact) {?>
                                                    <tr>
                                                        <th>User Name <?php echo $indxx++; ?></th>
                                                        <td colspan="3" style="text-align: left;"><a target="_blank" href="<?=base_url('company/contact/view/'.$client_contact->id)?>"><?php echo $client_contact->name; ?></a></td>
                                                        <!-- <th>User Designation</th>
                                                        <td style="text-align: left;"><?php echo $client_contact->designation_name; ?></td> -->
                                                    </tr>
                                                <?php    
                                                }
                                            }?>
                                            ...
                                            <tr>
                                                <th>RFQ/PR No.</th>
                                                <td style="text-align: left;"><?php echo $row->rfq_pr_no; ?></td>
                                                <td></td><td></td>
                                            </tr>
                                            <tr>
                                                <th>Currency Factor</th>
                                                <td style="text-align: left;"><?php echo $row->currency_factor; ?></td>
                                                <td></td><td></td>
                                            </tr>
                                            <tr>
                                                <th>Client Subject</th>
                                                <td style="text-align: left;"><?php echo $row->client_subject; ?></td>
                                                <td></td><td></td>
                                            </tr>
                                            <tr>
                                                <th>Internal Subject</th>
                                                <td style="text-align: left;"><?php echo $row->internal_subject; ?></td>
                                                <td></td><td></td>
                                            </tr>
                                            <?php 
                                            ...
                                            foreach ($offer_revision_list as $offer_revision_key => $offer_revision) {?>
                                            <tr>
                                                <th>Rev <?php echo $offer_revision->revision; ?> offer</th>
                                                <td style="text-align: right;"><?php echo number_format($offer_revision->total_unit_offer_price, '2', '.', ',') ?></td>
                                                <th>Given by </th>
                                                <td style="text-align: left;"><?php echo $offer_revision->given_by ?></td>
                                            </tr>
                                            <?php } }?>
                                            ...
                                            <tr>
                                                <th>Delivery Days</th>
                                                <td style="text-align: left;"><?php echo isset($row->delivery_days) && !empty($row->delivery_days)?$row->delivery_days:'---'; ?></td>
                                                <td></td><td></td>
                                            </tr>
                                            <tr>
                                                <th>Payment terms</th>
                                                <td style="text-align: left;"><?php echo isset($row->payment_terms) && !empty($row->payment_terms)?$row->payment_terms:'---'; ?></td>
                                                <td></td><td></td>
                                            </tr>
                                            <tr>
                                                <th>Current Price Validity</th>
                                                
                                                <td style="text-align: left;"><?php echo isset($row->current_price_validity) && !empty($row->current_price_validity)?$row->current_price_validity:'---'; ?></td>
                                                <td></td><td></td>
                                            </tr>
                                            <tr>
                                                <th>Freight</th>
                                             ...
                                             <tr>
                                                ...
                                                <td style="text-align: left;"><?php echo $row->internal_status; ?></td>
                                                <td></td><td></td>
                                            </tr>
                                            <tr>
                                                <th>Note-</th>
                                                <td colspan="3" style="text-align: left;"><?php echo $row->notes; ?></td>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="3" style="text-align: left;">
                                                    <form style="margin:unset;" action="<?=current_url()?>" method="post" accept-charset="utf-8" class="form-horizontal" enctype="multipart/form-data">
                                                            ...
                                                            <?php 
                                                            foreach ($enquiry_status_india_master as $key => $value) {?>
                                                                <option <?= isset($result->current_status) && $result->current_status==$value->form_id?'selected':'' ?> value="<?php echo $value->form_id; ?>"><?php echo $value->name; ?></option>
                                                           <?php }?>
                                                ...
                                                <td colspan="3" style="text-align: left;">
                                                    <form style="margin:unset;" action="<?=current_url()?>" method="post" accept-charset="utf-8" class="form-horizontal" enctype="multipart/form-data">
                                                        <select required="" class="form-control" name="status_id">
                                                            <option value="">Select Status</option>
                                                            <?php 
                                                            foreach ($enquiry_status_china_master as $key_china => $value_china) {?>
								...
								<div class="master-container overflow-box">
									<table class="responsive table table-bordered">
										...
										<tbody>
											...
											$i = 1;?>
										  	<tr>
												<td style="text-align: left;"><?=$mail_list->id?></td>
												<td style="text-align: left;"><a target="_blank" href="<?=$module_url?>/view_email/<?=$mail_list->id?>/1"><?=$mail_list->subject?></a></td>
												<td style="text-align: left;"><?=$mail_list->from_email?></td>
												<td style="text-align: left;"><?=$mail_list->to_email?></td>
												...
												<td>
													<a target="_blank" href="<?=$module_url?>/view_email/<?=$mail_list->id?>/1" class="" > <i class="fa fa-eye"></i> </a>
                                ...
                                <div class="master-container overflow-box">
                                    <table class="responsive table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style="text-align: left;"><?=$mail_list->id?></td>
                                                <td style="text-align: left;"><a target="_blank" href="<?=$module_url?>/view_email/<?=$mail_list->id?>/2"><?=$mail_list->subject?></a></td>
                                                <td style="text-align: left;"><?=$mail_list->from_email?></td>
                                                <td style="text-align: left;"><?=$mail_list->to_email?></td>
                                                <td style="text-align: left;"><?php echo isset($mail_list->mail_date) && strtotime($mail_list->mail_date)?date('d/m/Y',strtotime($mail_list->mail_date)):'--/--/----' ?></td>
                                                <!-- <td style="text-align: left;">---</td> -->
                                                <td>
                                                    <a target="_blank" href="<?=$module_url?>/view_email/<?=$mail_list->id?>/2" class="" > <i class="fa fa-eye"></i> </a>
						...
						<div class="sub-division" id="conversation">
							<div class="form-row row-fluid">
								<div class="form-actions">
									<h3>Conversation
                                    <span onclick="getTicket('<?=$result->form_id?>','<?=$user_id?>')" class="chat_box btn btn-info" data-ticket_id="<?=$result->form_id?>" data-ticket_status="1" id="chat_box_<?=$result->form_id?>_<?=$user_id?>" style="cursor:pointer; position: relative;"><i class="fa fa-comments-o" aria-hidden="true"></i></span>
                                </h3>
								</div>
                                <div class="col-sm-12">
								...
								<div class="col-sm-12">
									<div class="form-row row-fluid m-b-10">
			                                				...
			                                				foreach ($document_list as $key => $document) {
					                                			...
					                                			<li title="click to view details">
					                                				...
					                                				<div class="document-info">
					                                					<span class="doc">
					                                						<h4>Document Info <a href="javascript: history.go(0)"><span class="close-document-info" style="float: right;cursor: pointer;" >x</span></a></h4>
					                                						<ul>
			                            ...
			                            <div class="span6">
			                                <div class="document-wrapper">
			                                	<h4>Inch India to Inch China <span onclick="set_documement_type(2, 'Inch India to Inch China','<?=$result->form_id?>')" data-toggle="modal" data-target="#add_document_modal" style="padding: 2px" class="btn btn-xs pull-right"><i class="fa fa-plus">Add</i></span></h4>
			                                	<div class="document-list">
			                                		<ul>
			                                			<?php 
			                                			if(isset($document_list) && !empty($document_list))
			                        ...
			                        <div class="form-row row-fluid m-b-10">
			                        	<div class="span6">
			                                <div class="document-wrapper">
			                                	<h4>Inch China to China Supplier <span onclick="set_documement_type(3, 'Inch China to China Supplier','<?=$result->form_id?>')" data-toggle="modal" data-target="#add_document_modal" style="padding: 2px" class="btn btn-xs pull-right"><i class="fa fa-plus">Add</i></span></h4>
			                                	<div class="document-list">
			                                		<ul>
			                                			<?php 
			                                			if(isset($document_list) && !empty($document_list))
			                            ...
			                            <div class="span6">
			                                <div class="document-wrapper">
			                                	<h4>China Supplier to Inch China <span onclick="set_documement_type(4, 'China Supplier to Inch China','<?=$result->form_id?>')" data-toggle="modal" data-target="#add_document_modal" style="padding: 2px" class="btn btn-xs pull-right"><i class="fa fa-plus">Add</i></span></h4>
			                                	<div class="document-list">
			                                		<ul>
			                                			<?php 
			                                			if(isset($document_list) && !empty($document_list))
			                        ...
			                        <div class="form-row row-fluid m-b-10">
			                            <div class="span6">
			                                <div class="document-wrapper">
			                                	<h4>Inch China to Inch India <span onclick="set_documement_type(5, 'Inch China to Inch India','<?=$result->form_id?>')" data-toggle="modal" data-target="#add_document_modal" style="padding: 2px" class="btn btn-xs pull-right"><i class="fa fa-plus">Add</i></span></h4>
			                                	<div class="document-list">
			                                		<ul>
			                                			<?php 
			                                			if(isset($document_list) && !empty($document_list))
			                        ...
			                        <div class="form-row row-fluid m-b-10">
			                            ...
			                            <div class="span6">
			                                <div class="document-wrapper">
			                                	<h4>Miscellaneous India <span onclick="set_documement_type(7, 'Miscellaneous Document','<?=$result->form_id?>')" data-toggle="modal" data-target="#add_document_modal" style="padding: 2px" class="btn btn-xs pull-right"><i class="fa fa-plus">Add</i></span></h4>
			                                	<div class="document-list">
			                                		<ul>
			                                			<?php 
			                                			if(isset($document_list) && !empty($document_list))
                                        ...
                                        <div class="span6">
                                            <div class="document-wrapper">
                                                <h4>Miscellaneous China <span onclick="set_documement_type(8, 'Miscellaneous Document','<?=$result->form_id?>')" data-toggle="modal" data-target="#add_document_modal" style="padding: 2px" class="btn btn-xs pull-right"><i class="fa fa-plus">Add</i></span></h4>
                                                <div class="document-list">
                                                    <ul>
                                                        <?php 
                                                        if(isset($document_list) && !empty($document_list))
							...
							<div class="form-row row-fluid">
								<div class="form-actions">
									<h3>Product Info 
                                        ...
                                        <?php if($is_india){ ?>
										<span class="pull-right"><a onclick="final_release_quotation2(this, '<?=$result->form_id?>')" href="javascript:void(0)" class="btn btn-sm btn-info add_quotation_btn"><i class="ace-icon fa fa-exchange align-top bigger-125"></i> Release</a></span>
										<span class="pull-right "><a data-toggle="modal" data-target="#add_product_modal" data-href="<?=$module_url?>/add_product/<?=$result->form_id?>" class="btn btn-xs btn-info add_product_modal_btn"><i class="ace-icon fa fa-plus align-top bigger-125"></i> Add Product</a>&nbsp;&nbsp;&nbsp;</span>
                                        <?php } ?>
                                        <?php if($is_china || 1){ ?>
                                        <span class="pull-right "><a data-href="<?=$module_url?>/download_supplier_sheet/<?=$result->form_id?>" class="btn btn-xs btn-info download_supplier_sheet_btn"><i class="ace-icon fa fa-download align-top bigger-125"></i> Download Supplier Sheet</a>&nbsp;&nbsp;&nbsp;</span>
                                        <?php } ?>
									</h3>
								</div>
									...
									<table class="table">
										<thead>
											<tr>
												...
												<th style="width: 90px;">Comm ID</th>
												<th>Customer Description</th>
												<th>Inch Description</th>
												<th style="width: 125px;">Inch Make</th>
										...
										<tbody>
											...
											foreach ($product_list as $p_key => $product) {?>
												<tr>
													...
													<td style="text-align: left;"><?php echo $result->enq_no.'-'.$i++ ?></td>
													...
													<td>
														<a href="javascript:void(0)" class="quotaion_expndbtn products" data-index="<?php echo $product->form_id ?>">Show</a>
													</td>
                                                    <?php if($is_india){ ?>
													<td>
								                        <a data-toggle="modal" data-target="#edit_product_modal"  class="hide"> <i class="fa fa-pencil-square-o"></i> </a>

								                        <a href="javascript:void(0)" data-href="<?=$module_url.'/edit_product/'.$product->form_id.'/'.$result->form_id?>" data-id="<?=$product->form_id?>" class="edit_product_modal_btn"> <i class="fa fa-pencil-square-o"></i> </a> 
												...
												<tr style="display: none;border: green solid 1px;" class="quatation-container quotaion_<?php echo $product->form_id ?>">
													<td colspan="9" style="border: green solid 1px;">
														<div class="form-actions">
															<h3 style="margin-bottom: 0px;padding-top: 0px;">Quotation List 
                                                                <!-- <?php if($is_china || $user_id = $result->inch_name){ ?> -->
																<span class="pull-right1"><a style="padding: 2px;" href="<?=$module_url?>/add_quotation/<?=$product->form_id?>/<?=$result->form_id?>" class="btn btn-sm btn-info add_quotation_btn"><i class="ace-icon fa fa-plus align-top bigger-125"></i> Add Quotation</a></span>
                                                                <!-- <?php } ?> -->
                                                                <?php if($is_india){ ?>
																<!-- <span class="pull-right1"><a onclick="release_quotation(this, '<?=$product->form_id?>', '<?=$result->form_id?>')" style="padding: 2px;" href="javascript:void(0)" class="btn btn-sm btn-info add_quotation_btn"><i class="ace-icon fa fa-exchange align-top bigger-125"></i> Release</a>&nbsp;&nbsp;&nbsp;</span> -->
                                                                <?php } ?>

															<!-- <h3 style="margin-bottom: 0px;padding-top: 0px;">Quotation List <span class="pull-right"><a data-toggle="modal" data-target="#add_quotation_modal" style="padding: 2px;" data-href="<?=$module_url?>/add_quotation/<?=$product->form_id?>/<?=$result->form_id?>" class="btn btn-sm btn-info add_quotation_btn"><i class="ace-icon fa fa-plus align-top bigger-125"></i> Add Quotation</a></span></h3> -->

														</div>
														<div class="overflow-box">
															<table class="table table_quotation" style="min-width: 160%">
																<thead>
																	<tr>
																		<th style="width: 30px">Sr. No.</th>
                                                                        <?php if($is_india){ ?>
																		<th style="width: 40px">Release</th>
                                                                        <?php } ?>
																		<th style="width: 80px">Added By</th>
                                                                        <th style="width: 180px;">Supplier Name</th>
																		<th style="width: 150px;">Type of Supplier</th>
																		<th style="width: 100px;">Unit Price</th>
																		<th style="width: 50px">VAT %</th>
																		<th style="width: 80px">Unit Price with Tax</th>
																		<th style="width: 80px">Total Price with Tax</th>
																		<th style="width: 80px">Delivery days</th>
																		<th style="width: 80px">Payment Terms</th>
																		<th style="width: 80px">Validity days</th>
																		<th style="width: 80px">Delivery Cost</th>
																		<th style="width: 80px">Packing Cost</th>
																		<th style="width: 80px">Warranty Months</th>
																...
																<tbody>
																	<?php 
																	if(isset($product->quotation_list) && !empty($product->quotation_list))
																	{
																	$j=1;
																	foreach ($product->quotation_list as $p_key => $quotation) {?>
																		<tr <?php echo $quotation->status==1?'style="background: #c0ffc0" class="released"':''?>>
																			<td><?php echo $j++ ?></td>
																			<?php if($is_india){ ?>
                                                                            <td>
                                                                                <?php if($quotation->status!='1'){ ?>
																				<input <?php echo $quotation->status==1?'checked':''?> type="radio" class="release_quotation_cls" name="release_<?=$product->form_id?>" value="<?php echo $product->form_id.'-'.$quotation->form_id?>">
                                                                            <?php } ?>
																			</td>
                                                                            <?php } ?>
																			<td><?php echo $quotation->added_by_name ?></td>
																			<?php if($quotation->supplier_country == '2'):?>
                                                                            	<td><?php echo $quotation->supplier ?></td>
                                                                            <?php else:?>
                                                                            	<td><?php echo $quotation->supplier_ind ?></td>
                                                                        	<?php endif;?>
																			<td><?php echo $quotation->supplier_type_name ?></td>
																			<td><?php echo $quotation->unit_price ?></td>
																			<td><?php echo $quotation->vat ?></td>
																			<td><?php echo $quotation->unit_price_with_tax ?></td>
																			<td><?php echo $quotation->total_price_with_tax ?></td>
																			<td><?php echo $quotation->delivery_days ?> Days</td>
																			
																			<td><?php echo $quotation->payment_terms ?></td>
																			<td><?php echo $quotation->validity_days ?></td>
																			<td><?php echo $quotation->delivery_cost ?></td>
																			<td><?php echo $quotation->packing_cost ?></td>
																			<td><?php echo $quotation->warranty_month ?></td>
																			<td><?php echo $quotation->status==0?'<span class="label label-danger">Pending</span>':'<span class="label label-success">Released</span>' ?></td>
                                                                            <td><?php echo $quotation->gw ?></td>
                                                                            <?php if($is_china){ ?>
                                                                            <td>
                                                                                <a href="<?=$module_url.'/edit_quotation/'.$quotation->form_id.'/'.$product->form_id.'/'.$result->form_id?>"><i class="fa fa-pencil-square-o"></i> </a>
                                                                                <a href="<?=$base_url.'/delete_quotation/'.$quotation->form_id.'/'.$result->form_id?>"  class="delete" onclick=" return confirm('Are you really want to delete this quotation?')"> <i class="fa fa-trash-o"></i> </a>
                                                                            </td>
                                                                            <?php } ?>
											...
											<?php }
                                                ...
                                                echo "<tr><td style='color:red;text-align:center' colspan='8'>No product found</td></tr>";
                                            } ?>
										</tbody>
									</table>
								</div>
						...
						<div class="sub-division" id="transalation">
							<div class="form-row row-fluid">
								...
								<div class="product-wrapper overflow-box">
									<table class="table" style="min-width: 130%">
										<thead>
											<tr>
												<th style="width: 90px;">Comm ID</th>
												<th>Customer Description</th>
												<th>Inch Description</th>
												<th style="width: 125px;">Inch Make</th>
												<th style="width: 250px;">CFIT Description</th>
												<th style="width: 125px;">CFIT Make</th>
												<th style="width: 50px;">Qty</th>
												<th style="width: 60px;">UOM</th>
                                                <?php if($is_china){ ?>
                                                <th style="width: 50px;">Action</th>
										...
										<tbody>
											...
											foreach ($product_list as $p_key => $product) {?>
												<tr>
                                                    ...
                                                    <?php if($is_china){ ?>
                                                    <td>
                                                        <a href="javascript:void(0)" data-href="<?=$module_url.'/edit_product/'.$product->form_id.'/'.$result->form_id.'/china'?>" data-id="<?=$product->form_id?>" class="edit_product_china_modal_btn"> <i class="fa fa-pencil-square-o"></i> </a> 
                                                    </td>
                                                    <?php } ?>
												</tr>
											<?php }}else{
                        ...
                        <?php if($is_india){ ?>
						<!-- Start Offer -->
						<div class="sub-division" id="offer">
							<div class="form-row row-fluid">
								<div class="form-actions">
									<h3>Offer</h3>
								</div>
								<div class="product-wrapper overflow-box">
									<table class="table" style="min-width: 230%">
										<thead>
											<tr>
												<th style="width: 120px;">Comm ID</th>
												<th style="width: 300px;">Inch Description</th>
												<th style="width: 125px;">Inch Make</th>
												<th style="width: 50px;">Qty</th>
												<th style="width: 60px;">UOM</th>
												<!-- <th style="width: 200px;">CFIT Description</th> -->
												<!-- <th style="width: 125px;">CFIT Make</th> -->
												<th style="width: 50px;">Vat</th>
												<th style="width: 100px;">Unit Price</th>
												<th style="width: 80px;">Unit Price Tax</th>
												<th style="width: 80px;">Total Price Tax</th>
												<th style="width: 80px;">Delivery Days</th>
												...
												<th style="width: 150px;">Supplier Type</th>
												<th >Remarks</th>
											</tr>
										</thead>
										<tbody>
											...
											foreach ($offer_list as $p_key => $offer) {
                                                ...
                                                $curr_revision_product_id = $offer->product_id;
												...
												<tr>
													<td style="text-align: left;"><?php echo $result->enq_no.'-'.$i.'- Rev-'.$offer->revision ?></td>
													<td style="text-align: left;cursor: pointer;" title="<?=$offer->description_issued_by_inch?>"><?php echo substr($offer->description_issued_by_inch, 0, 40) ?>...</td>

                                                    <td style="text-align: left;cursor: pointer;" title="<?=$offer->make_issue_inch?>"><?php echo strlen($offer->make_issue_inch)>13?substr($offer->make_issue_inch, 0, 13).'...':$offer->make_issue_inch ?></td>

													<td style="text-align: left;"><?php echo $offer->qty ?></td>
													<td style="text-align: left;"><?php echo $offer->unit_name ?></td>
													<!-- <td style="text-align: left;"><?php echo $offer->description_issued_by_cfit ?></td> -->
													<!-- <td style="text-align: left;"><?php echo $offer->make_issue_cfit ?></td> -->
													<td style="text-align: right;"><?php echo $offer->vat ?>%</td>
													<td style="text-align: right;"><?php echo $offer->unit_price ?></td>
													<td style="text-align: right;"><?php echo $offer->unit_price_with_tax ?></td>
													<td style="text-align: right;"><?php echo $offer->total_price_with_tax ?></td>
													<td style="text-align: right;"><?php echo $offer->delivery_days ?></td>
													<td style="text-align: left;cursor: pointer;" title="<?=$offer->payment_terms?>"><?php echo strlen($offer->payment_terms)>13?substr($offer->payment_terms, 0, 13).'...':$offer->payment_terms ?></td>
													<td style="text-align: right;"><?php echo $offer->validity_days ?></td>
													<td style="text-align: right;"><?php echo $offer->delivery_cost ?></td>
													<td style="text-align: right;"><?php echo $offer->packing_cost ?></td>
													<td style="text-align: right;"><?php echo $offer->warranty_month ?></td>
													<td style="text-align: left;cursor: pointer;" title="<?=$offer->supplier?>"><?php echo substr($offer->supplier, 0, 40) ?></td>
													<td style="text-align: left;cursor: pointer;" title="<?=$offer->supplier_type_name?>"><?php echo substr($offer->supplier_type_name, 0, 20) ?></td>
													<td style="text-align: right;"><?php echo $offer->gw ?></td>
												</tr>
											<?php }}else{
                                                echo "<tr><td style='color:red;text-align:center' colspan='20'>No record found</td></tr>";
                                            } ?>
										</tbody>
									</table>
								</div>
						...
						<!-- Start Price Calc -->
						<div class="sub-division" id="price-calc">
							<div class="form-row row-fluid">
								<div class="form-actions">
									<h3>Price Calc 
                                        <?php if($is_india){ ?>
                                        
										<span class="pull-right"><a target="_blank" data-href="<?=$module_url?>/freeze_quotation/<?=$result->form_id?>" class="btn btn-sm btn-info prepare_btn freeze_quotation_btn"><i class="ace-icon fa fa-hand-o-left align-top bigger-125"></i> Freeze</a></span>
                                        <span class="pull-right"><a target="_blank" data-href="<?=$module_url?>/quotation_print/<?=$result->form_id?>?action=print" class="btn btn-sm btn-info prepare_btn print_btn"><i class="ace-icon fa fa-print align-top bigger-125"></i> Print</a>&nbsp;&nbsp;&nbsp;</span>
										<span class="pull-right"><a download1 target="_blank" data-href="<?=$module_url?>/quotation_download/<?=$result->form_id?>?action=download" class="btn btn-sm btn-info prepare_btn download_btn"><i class="ace-icon fa fa-download align-top bigger-125"> </i> Download</a>&nbsp;&nbsp;&nbsp;</span>
                                        <span class="pull-right" style="margin-right: 10px;">
                                            <select id="revision_no" class="nostyle" style="min-width: 100px;">
                                                <option value="">Select Revision</option>
                                                <?php foreach ($total_revision as $key => $revision_no) {?>
								...
								<div class="product-wrapper overflow-box">
									<table class="table" style="min-width: 170%">
										<thead>
											<tr>
                                                <th  class="ch" width="3%">
                                                    <input type="checkbox" value="all" class="checkall_offer">
                                                </th>
												<th style="width: 100px;">Comm ID</th>
                                                <th style="width: 40px;">Action</th>
												<th style="width: 280px">Customer Description</th>
												<th style="width: 50px">Qty</th>
												<th style="width: 100px;">Landed Unit Cost</th>
												<th style="width: 100px;">Landed Total Cost</th>
												<th style="width: 40px">Margin</th>
												<th style="width: 100px;">Unit Offer Price</th>
												<th style="width: 100px;">Total Offer Price</th>
												<th style="width: 40px">CF</th>
												<th style="width: 80px;">Unit Price Tax</th>
												<th style="width: 80px;">Total Price Tax</th>
                                                <th style="width: 100px;">Shipping Cost C-I</th>
												<th style="width: 100px">HSN Code</th>
                                                <th style="width: 80px;">Customs Duty %</th>
												<th style="width: 80px;">Basic Customs Duty</th>
												<th style="width: 100px;">Shipping Cost I</th>
											</tr>
										</thead>
										<tbody>
											<?php 
											if(isset($price_calc_list) && !empty($price_calc_list))
											{

                                            $i=0;
                                            $prev_revision_product_id = 0;
                                            $curr_revision_product_id = 0;
                                            foreach ($price_calc_list as $p_key => $offer_calc){
                                                $prev_revision_product_id = $curr_revision_product_id;
                                                $curr_revision_product_id = $offer_calc->product_id;
												...
												<tr>
                                                    <td  class="ch" width="3%">
                                                        <?php if($offer_calc->is_freeze!=1){ ?>
                                                        <input type="checkbox" value="<?=$offer_calc->id?>" class="offer_checkbox"/>
                                                        <?php }else{
                                                            echo '<label class="label label-success">Freezed</label>';
                                                        } ?>
                                                    </td>
                                                    
													<td style="text-align: left;"><?php echo $result->enq_no.'-'.$i.'- Rev-'.$offer_calc->revision ?></td>
                                                    <td>
                                                        <?php if($offer_calc->is_freeze!=1){ ?>
                                                        <a href="<?=$module_url.'/edit_offer/'.$offer_calc->id.'/'.$offer_calc->product_id.'/'.$offer_calc->enquiry_id?>" class="edit_offer_btn"> <i class="fa fa-pencil-square-o"></i> </a> 
                                                        <?php }else{
                                                            echo '<label class="label label-info">Sent</label>';
                                                        } ?>
                                                    </td>
													<td style="text-align: left;cursor: pointer;" title="<?=$offer_calc->description_issued_by_customer?>"><?php echo substr($offer_calc->description_issued_by_customer, 0,40) ?>...</td>
													<td style="text-align: right;"><?php echo $offer_calc->qty ?></td>
                                                    <td style="text-align: right;"><?php echo $offer_calc->unit_price_landed_cost ?></td>
                                                    <td style="text-align: right;"><?php echo $offer_calc->total_landed_price ?></td>
                                                    <td style="text-align: right;"><?php echo $offer_calc->margin ?></td>
                                                    <td style="text-align: right;"><?php echo $offer_calc->unit_offer_price ?></td>
                                                    <td style="text-align: right;"><?php echo $offer_calc->total_unit_offer_price ?></td>
                                                    <td style="text-align: right;"><?php echo $offer_calc->cf ?></td>
                                                    <td style="text-align: right;"><?php echo $offer_calc->unit_price_with_tax ?></td>
                                                    <td style="text-align: right;"><?php echo $offer_calc->total_price_with_tax ?></td>
                                                    
                                                    <td style="text-align: right;"><?php echo $offer_calc->shipping_cost_china_india ?></td>
                                                    <td style="text-align: right;cursor: pointer;" title="<?=$offer_calc->hsn_name?>"><?php echo strlen($offer_calc->hsn_name)>13?substr($offer_calc->hsn_name, 0, 12).'...':$offer_calc->hsn_name ?></td>
                                                    <td style="text-align: right;"><?php echo $offer_calc->customs_duty ?>%</td>
                                                    <td style="text-align: right;"><?php echo $offer_calc->basic_custom_duty ?></td>
                                                    <td style="text-align: right;"><?php echo $offer_calc->shipping_cost_india ?></td>
												</tr>

											<?php }}else{
                                                echo "<tr><td style='color:red;text-align:center' colspan='16'>No record found</td></tr>";
                                            } ?>
										</tbody>
									</table>
								</div>
				                ...
				                <form action="#" method="post" accept-charset="utf-8" class="form-horizontal" id="add_product_form" enctype="multipart/form-data">
				                    ...
				                    <div class="portlet-body" style="padding: 5px;">
				                        ...
				                        <div class="form-row row-fluid m-b-10">
				                            ...
				                            <div class="span6">
				                                <div class="span5">
				                                    <label for="age" class="form-label">Customer Description<em>*</em></label>
				                                </div>
				                                <div class="span7">
				                                    <textarea required="" type="text" name="description_issued_by_customer" id="description_issued_by_customer" value="" class="span12 unique" rows="7"></textarea>
				                            ...
				                            <div class="span6">
				                                ...
				                                <div class="span7">
				                                    <textarea required="" type="text" name="description_issued_by_inch" id="description_issued_by_inch" value="" class="span12 unique" rows="7"></textarea>
				                        ...
				                        <div class="form-row row-fluid m-b-10">
				                            ...
				                            <div class="span6" id="5">
				                                ...
				                                <div class="span7">
				                                    <select required="" name="hsn_code" class="span12 nostyle chosen-select">
				                    ...
				                    <div class="portlet-body" style="padding: 5px;">
				                        <div class="form-row row-fluid m-b-10">
				                            <div class="span6">
				                                ...
				                                <div class="span7">
				                                    <textarea required="" type="text" name="description_issued_by_customer" id="description_issued_by_customer2" value="" class="span12 unique" rows="7"></textarea>
				                            ...
				                            <div class="span6">
				                                ...
				                                <div class="span7">
				                                    <textarea required="" type="text" name="description_issued_by_inch" id="description_issued_by_inch2" value="" class="span12 unique" rows="7"></textarea>
                                ...
                                <form action="#" method="post" accept-charset="utf-8" class="form-horizontal" id="edit_product_china_form" enctype="multipart/form-data">
                                    <div class="portlet-body" style="padding: 5px;">
                                        <div class="form-row row-fluid m-b-10">
                                            <div class="span6">
                                                <div class="span5">
                                                    <label for="age" class="form-label">CFIT Description<em>*</em></label>
                                                </div>
                                                <div class="span7">
                                                    <textarea required="" type="text" name="description_issued_by_cfit" id="description_issued_by_cfit" value="" class="span12 unique" rows="7"></textarea>
                                            ...
                                            <div class="span6">
                                                ...
                                                <div class="span7">
                                                    <textarea required="" class="make_issue_cfit span12 text" type="text" name="make_issue_cfit" id="make_issue_cfit" rows="7"></textarea>
                                ...
                                <form action="<?=$module_url?>/add_more_email/<?=$result->form_id?>" method="post" accept-charset="utf-8" class="form-horizontal" id="add_mail_tags_form" enctype="multipart/form-data">
                                        ...
                                        <div class="form-row row-fluid m-b-10">
                                            <div class="span12">
                                                ...
                                                <div class="span7">
                                                    ...
                                                    <div class="error" id="error_email_id"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row-fluid" style="margin-bottom:10px;">
                                        <div class="span12">
                                            <div class="form-actions" style="text-align: center;padding-left: unset;">
                                                <input type="hidden" name="<?=$this->config->item('csrf_token_name')?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
                                                <button class="btn  btn-info" onclick="check_email_id();" type="button"> Add</button>
                                                <button class="btn btn-danger" type="reset" name="reset">Reset</button>
                                                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
...
<div class="chatting_model modal right fade" id="chatting_model_id" tabindex="-1" role="dialog" aria-labelledby="myModalLabel2222" aria-hidden="false" style="display: none;">
    ...
    <div class="modal-dialog" role="document" >
        <div class="modal-content">
            ...
            <div class="modal-body" id="scrollable_div">
                <!--CHAT -->
...
<script type="text/javascript">
	...
	function set_documement_type(type, title, enquiry_id)
	{
		$("input[name='document_type']").val(type);
		$("input[name='enquiry_id']").val(enquiry_id);
    ...
    function final_release_quotation2(obj, enquiry_id)
    {
        if(confirm("Are you sure to release quotation?"))
        {
            var status          = 0;
            var quotation_ids   = [];
            $(".release_quotation_cls:checked").each(function(){
                quotation_ids.push($(this).val());
                
            });
            // console.log("quotation_ids:"+quotation_ids);
            // return false;
            if(Array.isArray(quotation_ids) && quotation_ids.length)
            {
                $.ajax({
                    url:module_url+'/release_final_quotation',
                    type:"POST",
                    dataType:'json',
                    data: token_name+"="+token_hash+"&enquiry_id="+enquiry_id+"&quotation_ids="+quotation_ids,
                    beforeSend:function()
                    {
                        beforeAjaxResponse();
                    },
	...
	$(document).ready(function(){
		...
		$('#chatting_model_id').on('shown.bs.modal', function (event) {
			$('#scrollable_div').scrollTop($('#scrollable_div')[0].scrollHeight);
		});
                ...
                $.ajax({
                    ...
                    success:function(res)
                    {
                        ...
                        if(res.status==1)
                        {
                            ...
                            {
                                $("#edit_product_china_form textarea[name='make_issue_cfit']").text(data.make_issue_cfit);
...
$(document).ready(function() {
    ...
    $('.reply_input').keypress(function(event) {
        ...
        if (keycode == '13') {
            ...
            //alert();
            $(".chat_start").append("<li class='chat_thread by_user'><h5>"+user_name+": <small class='chat_time'>"+datetime+" </small></h5><p class='chat_desc'>" + chatval + "</p></li>");
            $(".reply_input").val("");
        ...
        $.ajax({
            ...
            success: function(dat) {
                ...
                if (dat['status'] == "success") {
                    ...
                    $('#chatting_model_id').modal('show');
                } else if (dat['status'] == "error1") {
                    $(".chat_start").html("");
...
function check_email_id()
{
	...
	if(email_id)
	{
		$.ajax({
            type: 'POST',
            async: false,
            url: module_url+'/check_email_id',
            data: token_name+"="+token_hash+"&email_id="+email_id+"&mail_type="+mail_type,
            success: function(dat) {
                dat = JSON.parse(dat);
                if (dat['status'] == "error")
                {
                    $("#error_email_id").html(dat['message']);
                }
                else if (dat['status'] == "success")
                {
                	// alert('hi');
                	$("#error_email_id").html('');
                	$('#add_mail_tags_form').submit();
                    return true;
                }
            }
        });
...
$(document).ready(function() {
    ...
    $(".download_supplier_sheet_btn").click(function(){
        var ids = [];
    ...
    $(".document-list ul li").click(function(){
        $(".document-info").hide();
        $(this).find(".document-info").show();
    });

    $(".close-document-info").click(function(){
        // alert("");
        $(".document-info").hide();
