                                ...
                                <?php } ?>
                                        ...
                                        <div class="span6" id="<?=$key?>">
                                            ...
                                            <div class="span7">
                                                ...
                                                {?>
                                                    ...
                                                    <textarea <?=isset($iterat_arr[$k]->required) && $iterat_arr[$k]->required == 'true'?'required':''?> name="<?php echo $iterat_arr[$k]->name ?>" id="<?php echo $iterat_arr[$k]->name ?>" rows="<?php echo $iterat_arr[$k]->rows ?>" value="" class="span12 <?=$class_name_dynamic_unq;?>"></textarea>
                                                <?php } elseif($data_input=='texteditor'){?>
                                                    <textarea <?=isset($iterat_arr[$k]->required) && $iterat_arr[$k]->required == 'true'?'required':''?> name="<?php echo $iterat_arr[$k]->name ?>" id="<?php echo $iterat_arr[$k]->name ?>" rows="<?php echo $iterat_arr[$k]->rows ?>" value="" class="ckeditor- span12 <?=$class_name_dynamic_unq;?>"></textarea>
                                                ...
                                                <?php } else{ ?>
                                                        <input <?=isset($iterat_arr[$k]->is_readonly) && $iterat_arr[$k]->is_readonly == '1'?'readonly':''?> <?=isset($iterat_arr[$k]->required) && $iterat_arr[$k]->required == 'true'?'required':''?> type="text" name="<?php echo $iterat_arr[$k]->name ?>" id="<?php echo $iterat_arr[$k]->name ?>" value="" <?=$iterat_arr[$k]->name=='enq_no'?'placeholder=""':''?>  class="span12 <?=$class_name_dynamic_unq;?>" <?=$class_name_dynamic;?> >
                                    ...
                                    <?php } else if($iterat_arr[$k]->type == 'combo'){
                                        ...
                                        <div class="span6" id ="<?=$key?>">
                                            ...
                                            <div class="span7">
                                                <select <?=isset($iterat_arr[$k]->required) && $iterat_arr[$k]->required == 'true'?'required':''?> name="<?php echo $iterat_arr[$k]->name ?>" class="nostyle chosen-select">
                                    ...
                                    <?php } else if($iterat_arr[$k]->type == 'select'){
                                        ...
                                        if(isset($iterat_arr[$k]->option_type) && $iterat_arr[$k]->option_type=='table')
                                        {
                                            ...
                                            <div class="span6" id ="<?=$key?>">
                                                ...
                                                <div class="span7">
                                                    <select <?=isset($iterat_arr[$k]->required) && $iterat_arr[$k]->required == 'true'?'required':''?> name="<?php echo $iterat_arr[$k]->name ?>" class="span12 nostyle chosen-select <?php echo $iterat_arr[$k]->name ?>">
                                                        <option value="">Select <?php echo ucwords($iterat_arr[$k]->label) ?></option>
                                                        <?php
                                                        if(isset($options) && !empty($options)){
                                                            foreach($options as $option){ 
                                                            $option_arr = (array) $option;?>
                                                            <option value="<?php echo $option_arr[$value_name]; ?>" ><?php echo $option_arr[$label_name]; ?></option>
                                                        <?php }} ?>
                                                    </select>
                                                    <div class="error" id="error_field_label"><?php echo form_error('field_label');?></div>
                                                </div>
                                        ...
                                        {?>
                                            <div class="span6" id ="<?=$key?>">
                                                ...
                                                <div class="span7">
                                                    <select <?=isset($iterat_arr[$k]->required) && $iterat_arr[$k]->required == 'true'?'required':''?> name="<?php echo $iterat_arr[$k]->name ?>" class="span12 nostyle chosen-select1 <?php echo $iterat_arr[$k]->name ?>">
                                                        <option value="">Select <?php echo ucwords($iterat_arr[$k]->label) ?></option>
                                                    </select>
                                                    <div class="error" id="error_field_label"><?php echo form_error('field_label');?></div>
                                                </div>
                                    ...
                                    <?php }  else if($iterat_arr[$k]->type == 'multiselect'){
                                        ...
                                        if(isset($iterat_arr[$k]->option_type) && $iterat_arr[$k]->option_type=='table')
                                        {
                                            ...
                                            <div class="span6" id ="<?=$key?>">
                                                ...
                                                <div class="span7">
                                                    <select <?=isset($iterat_arr[$k]->required) && $iterat_arr[$k]->required == 'true'?'required':''?> multiple="" name="<?php echo $iterat_arr[$k]->name ?>[]" class="span12 multiselect12 nostyle chosen-select <?php echo $iterat_arr[$k]->name ?>">
                                        ...
                                        {?>
                                            ...
                                            <div class="span6" id ="<?=$key?>">
                                                ...
                                                <div class="span7">
                                                    <select <?=isset($iterat_arr[$k]->required) && $iterat_arr[$k]->required == 'true'?'required':''?> multiple="" name="<?php echo $iterat_arr[$k]->name ?>[]" class="span12 multiselect1 chosen-select1 nostyle <?php echo $iterat_arr[$k]->name ?>">
                                                        <option value="" disabled="">Select <?php echo ucwords($iterat_arr[$k]->label) ?></option>
                                                        ...
                                                        $.ajax({
                                                            ...
                                                            success:function(res){
                                                                if(res.status==1)
                                                                {
                                                                    ...
                                                                    // $(".<?=$iterat_arr[$k]->name?>").trigger("chosen:updated");
                                        ...
                                        <?php }else{
                                            ...
                                            <div class="span6" id ="<?=$key?>">
                                                ...
                                                <div class="span7">
                                                    <select <?=isset($iterat_arr[$k]->required) && $iterat_arr[$k]->required == 'true'?'required':''?> name="<?php echo $iterat_arr[$k]->name ?>" class="span12 chosen-select1">
                                                        <option value="">Select <?php echo ucwords($iterat_arr[$k]->label) ?></option>
                                                        <?php foreach($option as $opt){ ?>
                                                        <option value="<?php echo $opt->value; ?>" ><?php echo $opt->text; ?></option>
                                                        <?php } ?>
...
$(document).ready(function(){
    ...
    $("form").submit(function() { 
        ...
        if(Array.isArray(array_input_name) && array_input_name.length && Array.isArray(array_input_type) && array_input_type.length && Array.isArray(array_input_value) && array_input_value.length )
        {
            $.ajax({
                url:baseurl+'enquiry/form_module/check_all_fields_unq',
                type:"POST",
                dataType:'json',
