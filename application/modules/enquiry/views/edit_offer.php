                    ...
                    <div class="portlet-body" style="padding: 5px;">
                        ...
                        <div class="form-row row-fluid m-b-10">
                            ...
                            <div class="span6">
                                ...
                                <div class="span7">
                                    <textarea readonly required="" type="text" name="description_issued_by_customer" id="description_issued_by_customer" value="" class="span12 unique"><?php echo $revision_list->description_issued_by_customer ?></textarea>
                            ...
                            <div class="span6">
                                ...
                                <div class="span7">
                                    <input readonly="" class="qty span12 text" type="text" name="qty" id="qty" value="<?=$revision_list->qty?>">
                        ...
                        <div class="form-row row-fluid m-b-10">
                            <div class="span6">
                                ...
                                <div class="span7">
                                    <input onkeyup="calc_shipping_cost_china_india()" class="decimal_input currency_factor span12 text" type="text" name="cf" id="currency_factor" value="<?=$revision_list->cf?>">
                            ...
                            <div class="span6">
                                ...
                                <div class="span7">
                                    <input readonly="" required="" class="unit_price_with_tax span12 text decimal_input" type="text" name="unit_price_with_tax" id="unit_price_with_tax" value="<?php echo $revision_list->unit_price_with_tax ?>">
                        ...
                        <div class="form-row row-fluid m-b-10">
                            <div class="span6">
                                ...
                                <div class="span7">
                                    <input readonly="" required="" class="total_price_with_tax span12 text decimal_input" type="text" name="total_price_with_tax" id="total_price_with_tax" value="<?php echo $revision_list->total_price_with_tax*$revision_list->cf ?>">
                                    <div class="error" id="error_unit_price_with_tax"></div>
                                </div>
                            </div> 
                            <!-- <div class="span6">
                                ...
                                <div class="span7">
                                    <input onkeyup="calc_shipping_cost_china_india(this.value)" required="" class="shipping_cost_china_india_per span12 text" type="text" name="shipping_cost_china_india_per" id="shipping_cost_china_india_per" value="<?php echo $revision_list->shipping_cost_china_india_per ?>">
                            ...
                            <div class="span6">
                                ...
                                <div class="span7">
                                    <input autocomplete="off" onkeyup="calc_shipping_cost_china_india()" required="" class="decimal_input shipping_cost_china_india span12 text" type="text" name="shipping_cost_china_india" id="shipping_cost_china_india" value="<?php echo $revision_list->shipping_cost_china_india ?>">
                                    <div class="error" id="error_shipping_cost_china_india"></div>
                                </div>
                            </div> 
                        </div>
                        ...
                        <div class="form-row row-fluid m-b-10">
                            <div class="span6">
                                ...
                                <div class="span7">
                                    <input readonly="" required="" class="hsn_code span12 text" type="text" name="hsn_code" id="hsn_code" value="<?php echo $revision_list->hsn_name ?>">
                            ...
                            <div class="span6">
                                ...
                                <div class="span7">
                                    <input readonly="" required="" class="basic_custom_duty span12 text decimal_input" type="text" name="basic_custom_duty" id="basic_custom_duty" value="<?php echo $revision_list->basic_custom_duty ?>">
                        ...
                        <div class="form-row row-fluid m-b-10">
                            <div class="span6">
                                ...
                                <div class="span7">
                                    <input autocomplete="off" onkeyup="calc_shipping_cost_china_india()" class="shipping_cost_india span12 text decimal_input" type="text" name="shipping_cost_india" id="shipping_cost_india" value="<?php echo $revision_list->shipping_cost_india ?>">
                            ...
                            <div class="span6">
                                ...
                                <div class="span7">
                                    <input required="" readonly="" class="total_landed_price span12 text decimal_input" type="text" name="total_landed_price" id="total_landed_price" value="<?php echo $revision_list->total_landed_price ?>">
                        ...
                        <div class="form-row row-fluid m-b-10">
                            <div class="span6">
                                ...
                                <div class="span7">
                                    <input required="" readonly="" class="unit_price_landed_cost span12 text decimal_input" type="text" name="unit_price_landed_cost" id="unit_price_landed_cost" value="<?php echo $revision_list->unit_price_landed_cost ?>">
                            ...
                            <div class="span6">
                                ...
                                <div class="span7">
                                    <input autocomplete="off" onkeyup="calc_shipping_cost_china_india()" required="" class="margin span12 text decimal_input" type="text" name="margin" id="margin" value="<?php echo $revision_list->margin ?>">
                        ...
                        <div class="form-row row-fluid m-b-10">
                            <div class="span6">
                                ...
                                <div class="span7">
                                    <input readonly="" required="" class="decimal_input unit_offer_price span12 text" type="text" name="unit_offer_price" id="unit_offer_price" value="<?php echo $revision_list->unit_offer_price ?>">
                            ...
                            <div class="span6">
                                ...
                                <div class="span7">
                                    <input readonly="" required=""  class="decimal_input total_unit_offer_price span12 text" type="text" name="total_unit_offer_price" id="total_unit_offer_price" value="<?php echo $revision_list->total_unit_offer_price ?>">
...
<script>
    ...
    function calc_shipping_cost_china_india()
    {
        ...
        var unit_price_with_tax    	= '<?= $revision_list->unit_price_with_tax ?>';
        ...
        var customs_duty_per    = '<?= $revision_list->customs_duty ?>';
        ...
        var basic_custom_duty   = (scci_tpwt*customs_duty_per)/100;
