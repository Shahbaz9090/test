						...
						<div class="row-fluid">
							<label class="form-label span4" for="focusedInput"><?=lang('name')?><em>*</em></label>
							  <div class="row-fluid">
								...
								<input type="text" name="form_name" id="form_name" class="col-xs-10 col-sm-6 pull-right"  value="<?php echo set_value("form_name")?>">
						...
						<div class="row-fluid">
							<label class="form-label span4" for="focusedInput"><?=lang('form_label')?><em>*</em></label>
							  <div class="row-fluid">
								...
								<input type="text" name="form_label" id="form_label" class="col-xs-10 col-sm-6 pull-right" value="">
							...
							<label class="form-label span4" for="focusedInput"><?=lang('email_notify')?></label>
							 <div class="row-fluid">
								<div class="span6 ">  
								  ...
								  <input  type="text" name="email"  class="col-xs-10 col-sm-6 pull-right"  id="email">
