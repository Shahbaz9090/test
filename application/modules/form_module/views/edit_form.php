    ...
    <div class="span12">
        <div class="portlet box blue">
            <div class="title">
                ...
                <h4>
                     <!--<span class="icon16 brocco-icon-grid">--><span><?php $val = $name->form_label; echo "Edit ".$val; ?>
                    </span>
                </h4>
            ...
            <div class="content">
                ...
                <form action="<?php echo current_url() ?>" method="post" accept-charset="utf-8" class="form-horizontal" id="support_form" enctype="multipart/form-data">
                    ...
                    <div class="portlet-body" style="padding: 5px;">
                        <!--<div class="form-row row-fluid">
                            <div class="block-title">
                                <h3><?=isset($frm_data->block) && strtolower($frm_data->block)=='default'?$form_title:ucwords(strtolower($frm_data->block)) ?></h3>
                            </div>
                        </div>-->
                        <?php 
                                ...
                                <?php } ?>
                                            ...
                                            <div class="span7">
                                                ...
                                                {?>
                                                    ...
                                                    <textarea <?=isset($iterat_arr[$k]->required) && $iterat_arr[$k]->required == 'true'?'required':''?> name="<?php echo $iterat_arr[$k]->name ?>" id="<?php echo $iterat_arr[$k]->name ?>" rows="<?php echo $iterat_arr[$k]->rows ?>" class="span12 <?=$class_name_dynamic_unq;?>">
                                                        <?php echo isset($result[$cols->name])?$result[$cols->name]:'' ?>
                                                    </textarea>
                                                ...
                                                <?php } elseif($data_input=='number'){ ?>
                                                    <input type="text" oninput="this.value=this.value.replace(/[^0-9.]/,'')" name="<?php echo $iterat_arr[$k]->name ?>" id="<?php echo $iterat_arr[$k]->name ?>" value="<?php echo isset($result[$cols->name])?$result[$cols->name]:'' ?>" class="span12 <?=$class_name_dynamic_unq;?> " <?=$class_name_dynamic;?> >
                                                <?php }  elseif($iterat_arr[$k]->name=='enquiry_tag'){ ?>
                                                    <input type="text" name="<?php echo $iterat_arr[$k]->name ?>" id="<?php echo $iterat_arr[$k]->name ?>" value="<?php echo isset($result[$cols->name])?$result[$cols->name]:'' ?>" data-role="tagsinput" class="span12 <?=$class_name_dynamic_unq;?> " <?=$class_name_dynamic;?> >
                                                <?php } else{ ?>
                                                    <input <?=isset($iterat_arr[$k]->is_readonly) && $iterat_arr[$k]->is_readonly == '1'?'readonly':''?> <?=isset($iterat_arr[$k]->required) && $iterat_arr[$k]->required == 'true'?'required':''?> type="text" name="<?php echo $iterat_arr[$k]->name ?>" id="<?php echo $iterat_arr[$k]->name ?>" value="<?php echo isset($result[$cols->name])?$result[$cols->name]:'' ?>" class="span12 <?=$class_name_dynamic_unq;?>" <?=$class_name_dynamic;?> >
                                                <?php } ?>
                                        ...
                                        <div class="span6" id ="<?=$key?>">
                                            ...
                                            <div class="span7">
                                                <?php if(isset($iterat_arr[$k]->allowed_extensions) && is_array($iterat_arr[$k]->allowed_extensions) && count($iterat_arr[$k]->allowed_extensions)>0){ ?>
                                                    <input <?=isset($iterat_arr[$k]->required) && $iterat_arr[$k]->required == 'true'?'required':''?> onchange="validate__<?php echo $cols->name ?>(this)" type="file" name="<?php echo $cols->name ?>" id="field_label" value="" class="span12" >
                                                <?php }else{ ?>
                                                    <input <?=isset($iterat_arr[$k]->required) && $iterat_arr[$k]->required == 'true'?'required':''?> type="file" name="<?php echo $cols->name ?>" id="field_label" value="" class="span12" >
                                                <?php } ?>
                                    ...
                                    <?php }  else if($data_input == 'multiplefile'){ ?>
                                        ...
                                        <div class="span6" id="<?=$key?>">
                                            ...
                                            <div class="span7">
                                                <?php if(isset($iterat_arr[$k]->allowed_extensions) && is_array($iterat_arr[$k]->allowed_extensions) && count($iterat_arr[$k]->allowed_extensions)>0){ ?>
                                                    <input <?=isset($iterat_arr[$k]->required) && $iterat_arr[$k]->required == 'true'?'required':''?> onchange="validate__<?php echo $cols->name ?>(this)" multiple="" type="file" name="<?php echo $cols->name ?>[]" id="field_label" value="$result[$iterat_arr[$k]->name];" class="span12" >
                                                <?php }else{ ?>
                                                    <input <?=isset($iterat_arr[$k]->required) && $iterat_arr[$k]->required == 'true'?'required':''?> multiple="" type="file" name="<?php echo $cols->name ?>[]" id="field_label" value="$result[$iterat_arr[$k]->name]" class="span12" >
                                                <?php } ?>
                                                <div class="error" id="error_<?php echo $cols->name ?>"><?php echo form_error('field_label');?></div>
                                            </div>
                                        </div>
                                    ...
                                    <?php } else if($iterat_arr[$k]->type == 'combo'){
                                        ...
                                        <div class="span6" id ="<?=$key?>">
                                            ...
                                            <div class="span7">
                                                <select <?=isset($iterat_arr[$k]->required) && $iterat_arr[$k]->required == 'true'?'required':''?> name="<?php echo $iterat_arr[$k]->name ?>" class="nostyle chosen-select1">
                                    ...
                                    <?php } else if($iterat_arr[$k]->type == 'select'){ 
                                                ...
                                                <div class="span7">
                                                    <select <?=isset($iterat_arr[$k]->required) && $iterat_arr[$k]->required == 'true'?'required':''?> name="<?php echo $iterat_arr[$k]->name ?>" class="span12 nostyle chosen-select multiselect1_no <?php echo $iterat_arr[$k]->name ?>">
                                                        ...
                                                        if(isset($options) && !empty($options)){
                                                            ...
                                                            <option <?=isset($result[$cols->name]) && $result[$cols->name]==$option_arr[$value_name]?'selected':''?> value="<?php echo $option_arr[$value_name]; ?>" ><?php echo $option_arr[$label_name]; ?></option>
                                                        <?php }} ?>
                                                    </select>
                                                    <div class="error" id="error_field_label"><?php echo form_error('field_label');?></div>
                                                </div>
                                        ...
                                        {  
                                            ...
                                            $dpen_ids           = $result[$event_field];
                                            $dpnd_data          = $iterat_arr[$k]->options->dpnd_data;
                                            // pr($result[$event_field]);die;
                                            $all_ids = [];
                                            if(isset($result[$cols->name]) && !empty($result[$cols->name]))
                                            {
                                                $all_ids =  explode(",", $result[$cols->name]);
                                            }?>
                                            <div class="span6">
                                                <div class="span5">
                                                    <label for="age" class="form-label"><?php if($iterat_arr[$k]->type != 'password'){ echo $iterat_arr[$k]->label; } ?><em><?php if($iterat_arr[$k]->type != 'password' && $iterat_arr[$k]->required == 'true'){ echo "*"; } ?></em></label>
                                            ...
                                            <div class="span6" id ="<?=$key?>">
                                                ...
                                                <div class="span7">
                                                    <select <?=isset($iterat_arr[$k]->required) && $iterat_arr[$k]->required == 'true'?'required':''?> name="<?php echo $iterat_arr[$k]->name ?>" class="span12 nostyle chosen-select1">
                                                        ...
                                                        <?php foreach($option as $opt){ 
                                                         ?>
                                                            <option <?=isset($result[$cols->name]) && $result[$cols->name]==$opt->value?'selected':''?> value="<?php echo $opt->value; ?>" ><?php echo $opt->text; ?></option>
                                                        <?php } ?>
                                                    </select>
                                                    <div class="error" id="error_field_label"><?php echo form_error('field_label');?></div>
                                                </div>
                                    ...
                                    <?php } else if($iterat_arr[$k]->type == 'calendar'){ ?>
                                        ...
                                        <div class="span6" id="<?=$key?>">
                                            ...
                                            <div class="span7">
                                                <input <?=isset($iterat_arr[$k]->required) && $iterat_arr[$k]->required == 'true'?'required':''?> readonly="" class="<?php echo $iterat_arr[$k]->name ?> span12" type="text" name="<?php echo $iterat_arr[$k]->name ?>" id="<?php echo $iterat_arr[$k]->name ?>" value="<?php echo isset($result[$cols->name]) && strtotime($result[$cols->name])?date('Y-m-d',strtotime($result[$cols->name])):'' ?>">
                                                <div class="error" id="error_field_label"><?php echo form_error('field_label');?></div>
                                            </div>
                                        </div>
                                        <script type="text/javascript">
...
$(document).ready(function(){
    ...
    $("form").submit(function() { 
        ...
        var count_data1 = $("input.unique").length;
        if(count_data1==0)
        {
            form.submit();
        }
