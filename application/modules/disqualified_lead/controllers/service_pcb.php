...
class Service_Pcb extends MY_Controller {
    ...
    function __construct()
    {
        ...
        $this->data['base_url'] = base_url("disqualified_lead/service_pcb");
        ...
        $this->data['module_link'] = base_url("disqualified_lead/service_pcb")."/list_items";
	...
	{  
        ...
        foreach ($result['result'] as $row) { 
            if (!empty($row->display_id)) {
                $row->display_id = '<a href="'.base_url().'disqualified_lead/service_pcb/view/'.$row->id.'">#'.$row->display_id.'</a>';//'#'.$v[$val['name']];
  ...
  // ------------------------------------------------------------------------
     ...
     */
	  ...
	  return redirect(base_url('disqualified_lead/service_pcb/view/'.$_POST['lead_id']));
  }
   /**
	...
	public function qualified_form() {
	  ...
	  return redirect(base_url('disqualified_lead/service_pcb/list_items'));
  }
  /**
     * Add Product
     *
