                            ...
                            <div class="widget-body" >
                                <div class="widget-main">
                                    <div class="row-fluid">
                                        <div class="span9">
                                            <div class="boxes">
                                                <select name="category_tag" id="category_tag" class="nostyle chosen-select" >
                                                    <option value="" >Assign Category</option>
                                                    <?php foreach($getChinaEmailCategory as $key=>$val){ ?>
                                                        <option value="<?php echo $key; ?>"  <?= ($key == $result->type)?"selected='selected'":"" ?>><?php echo str_replace("Email China", '', $val); ?></option>
                                                    <?php } ?>
                                                </select>
                                        ...
                                        <div class="span3">
                                            <button type="button" onclick="assignCategory()" class="btn btn-success pull-right"><i class=" fa fa-check"></i></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
			...
			<div class="modal fade" id="addNoteModal" tabindex="-1" role="dialog"  style="width:500px;" aria-labelledby="myModalLabel" aria-hidden="true">
		 	...
		 	<div class="modal fade" id="reply_modal" tabindex="-1" role="dialog"  style="width:750px;" aria-labelledby="myModalLabel" aria-hidden="true">
			  	<div class="modal-dialog modal-lg">
					<div class="modal-content">
					  <?php echo form_open_multipart($base_url."/reply/".$result->id,array('class'=>'form-horizontal','role'=>'form','id'=>'reply_mail'));?>
					  <div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only"></span></button>
