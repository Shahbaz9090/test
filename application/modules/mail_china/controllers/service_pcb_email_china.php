...
class Service_pcb_email_china extends MY_Controller {
    ...
    public function __construct()
    {
        ...
        $this->data['base_url'] 		= base_url("mail_china/service_pcb_email_china");
        ...
        $this->data['module_link'] 		= base_url("mail_china/service_pcb_email_china")."/list_items";
