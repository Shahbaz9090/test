...
class Sales_governing_email_china extends MY_Controller {
    ...
    public function __construct()
    {
        parent::__construct();
        isProtected();
        $this->load->library('syncemaillib', 'Sales Governing Email List');
        ...
        $this->data['base_url'] 		= base_url("mail_china/sales_governing_email_china");
		...
		$this->data['module'] 			= 'Mail';
        $this->data['module_link'] 		= base_url("mail_china/sales_governing_email_china")."/list_items";
