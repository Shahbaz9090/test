...
class All_email_china extends MY_Controller {
    ...
    public function __construct()
    {
        ...
        $this->load->library('syncemaillib', 'All China Email List');
        ...
        $this->data['base_url'] 		= base_url("mail_china/all_email_china");
        ...
        $this->data['module_link'] 		= base_url("mail_china/all_email_china")."/list_items";
   ...
   public function release() 
    ...
    public function assignCategory() 
    {
        ...
        $this->syncemaillib->assignCategory();
