...
class Service_automation_email_china extends MY_Controller {
    ...
    public function __construct()
    {
        parent::__construct();
        isProtected();
        $this->load->library('syncemaillib', 'Service Automation Email List');
        ...
        $this->data['base_url'] 		= base_url("mail_china/service_automation_email_china");
        ...
        $this->data['module_link'] 		= base_url("mail_china/service_automation_email_china")."/list_items";
