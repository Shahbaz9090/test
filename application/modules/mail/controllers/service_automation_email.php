...
class Service_automation_email extends MY_Controller {
    ...
    public function __construct()
    {
        ...
        $this->data['base_url'] 		= base_url("mail/service_automation_email");
        ...
        $this->data['module_link'] 		= base_url("mail/service_automation_email")."/list_items";
