...
class Sales_pcb_email extends MY_Controller {
    ...
    public function __construct()
    {
        ...
        $this->data['base_url'] 		= base_url("mail/sales_pcb_email");
        ...
        $this->data['module_link'] 		= base_url("mail/sales_pcb_email")."/list_items";
