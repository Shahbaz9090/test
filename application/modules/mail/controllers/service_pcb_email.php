...
class Service_pcb_email extends MY_Controller {
    ...
    public function __construct()
    {
        parent::__construct();
        isProtected();
        $this->load->library('syncemaillib', 'Service PCB Email List');
        ...
        $this->data['base_url'] 		= base_url("mail/service_pcb_email");
        ...
        $this->data['module_link'] 		= base_url("mail/service_pcb_email")."/list_items";
