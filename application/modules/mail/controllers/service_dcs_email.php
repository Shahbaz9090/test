...
class Service_dcs_email extends MY_Controller {
    ...
    public function __construct()
    {
        ...
        $this->data['base_url'] 		= base_url("mail/service_dcs_email");
        ...
        $this->data['module_link'] 		= base_url("mail/service_dcs_email")."/list_items";
