...
class Sales_governing_email extends MY_Controller {
    ...
    public function __construct()
    {
        ...
        $this->data['base_url'] 		= base_url("mail/sales_governing_email");
        ...
        $this->data['module_link'] 		= base_url("mail/sales_governing_email")."/list_items";
