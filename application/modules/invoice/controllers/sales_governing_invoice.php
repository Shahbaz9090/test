...
class Sales_governing_invoice extends MY_Controller {
    ...
    public function __construct()
    {
        ...
        $this->load->library('invoice_lib', [$this, 'Sales Governing Invoice List', 2] );
        $this->lang->load('invoice', get_site_language());
        $this->data['title'] 	        = "Sales Spares Invoice";
        $this->data['readonly'] 		= NULL;
        $this->data['base_url'] 		= base_url("invoice/sales_governing_invoice/");
        $this->data['module_url'] 		= base_url("invoice/sales_governing_invoice/");
