...
class Sales_spares_invoice extends MY_Controller {
    ...
    public function __construct()
    {
        ...
        $this->load->library('invoice_lib', [$this, 'Sales Spares Invoice List', 1] );
        $this->lang->load('invoice', get_site_language());
        $this->data['title'] 	        = "Sales Spares Invoice";
        $this->data['readonly'] 		= NULL;
        $this->data['base_url'] 		= base_url("invoice/sales_spares_invoice/");
        $this->data['module_url']       = base_url("invoice/sales_spares_invoice/");
