                    ...
                    <div class="portlet-body" style="padding: 5px;">
                        ...
                        <div class="form-row row-fluid m-b-10">
                            ...
                            <div class="span6">
                                ...
                                <div class="span7">
                                    <input required oninput="this.value=this.value.replace(/[^0-9]/,'')" class="qty span12 text" type="text" name="qty" id="qty" value="<?php echo set_value('qty') ?>">
                                ...
                                <div class="span7">
                                    <select required="" name="uom" class="span12 nostyle chosen-select">
                                        ...
                                        foreach ($unit_master as $key => $unit) {?>
                                            <option <?php echo set_value('uom') && $unit->form_id==set_value('uom')?'selected':'' ?> value="<?php echo $unit->form_id ?>" data-vendor_type="<?php echo $unit->vendor_type ?>"><?php echo $unit->unit_name ?></option>
                                        <?php }
                                        }?>
                                    </select>
                        ...
                        <div class="form-row row-fluid m-b-10">
                            <div class="span6">
                                ...
                                <div class="span7">
                                    <select required="" name="hsn_code" class="span12 chosen-select nostyle">
                                        ...
                                        if(isset($hsncode_master) && !empty($hsncode_master))
                                        {
                                            foreach ($hsncode_master as $key => $hsncode) {?>
                                                ...
                                                <option <?php echo set_value('hsn_code') && $hsncode->hsn_name==set_value('hsn_code')?'selected':'' ?> value="<?php echo $hsncode->form_id?>"><?php echo $hsncode->hsn_name ?></option>
                                            <?php }
                                        }?>
                                    </select>
                            ...
                            <div class="span6">
                                ...
                                <div class="span7">
                                    <input required="" class="make_issue_inch span12 text" type="text" name="make_issue_inch" id="edit_make_issue_inch" value="<?php echo set_value('make_issue_inch') ?>">
                                ...
                                <div class="span7">
                                    ...
                                    <select class="span12 nostyle chosen-select" name="supplier" id="supplier" required="">
                                        ...
                                        foreach ($supplier_master as $key => $supplier) {?>
                                            <option <?php echo set_value('supplier') && $supplier->supplier_name==set_value('supplier')?'selected':'' ?> value="<?php echo $supplier->id ?>" data-vendor_type="<?php echo $supplier->vendor_type ?>"><?php echo $supplier->supplier_name ?></option>
                                        <?php }
                                        }?>
                                    </select>
                                ...
                                <div class="span7">
                                    ...
                                    <select class="span12 nostyle" name="supplier_type" required="">
                                        ...
                                        foreach ($supplier_type_master as $key => $supplier_type) {?>
                                            <option value="<?php echo $supplier_type->id ?>"><?php echo $supplier_type->name ?></option>
                                        <?php }
                                        }?>
                                    </select>
                        ...
                        <div class="form-row row-fluid m-b-10">
                            <div class="span6">
                                ...
                                <div class="span7">
                                    <input autocomplete="off" required="" oninput="this.value=this.value.replace(/[^0-9]/,'')" onkeyup="cal_unit_price()" class="vat span12 text" type="text" name="vat" id="vat" value="<?php echo set_value('vat')?>">
                            ...
                            <div class="span6" id="4">
                                ...
                                <div class="span7">
                                    <input autocomplete="off" required="" oninput="this.value=this.value.replace(/[^0-9]/,'')" onkeyup="cal_unit_price()" class="unit_price span12 text" type="text" name="unit_price" id="unit_price" value="<?php echo set_value('unit_price') ?>">
                        ...
                        <div class="form-row row-fluid m-b-10">
                            ...
                            <div class="span6" id="4">
                                ...
                                <div class="span7">
                                    <input readonly="" required="" oninput="this.value=this.value.replace(/[^0-9]/,'')" class="unit_price_with_tax span12 text" type="text" name="unit_price_with_tax" id="unit_price_with_tax" value="<?php echo set_value('unit_price_with_tax') ?>">
                            ...
                            <div class="span6">
                                ...
                                <div class="span7">
                                    <input readonly="" required="" oninput="this.value=this.value.replace(/[^0-9]/,'')" class="total_price_with_tax span12 text" type="text" name="total_price_with_tax" id="total_price_with_tax" value="<?php echo set_value('total_price_with_tax') ?>">
                        ...
                        <div class="form-row row-fluid m-b-10">
                            ...
                            <div class="span6" id="4">
                                ...
                                <div class="span7">
                                    <input  required="" oninput="this.value=this.value.replace(/[^0-9]/,'')" class="delivery_days span12 text" type="text" name="delivery_days" id="delivery_days" value="<?php echo set_value('delivery_days') ?>">
                            ...
                            <div class="span6">
                                ...
                                <div class="span7">
                                    <input required="" oninput="this.value=this.value.replace(/[^0-9]/,'')" class="gw span12 text" type="text" name="gw" id="gw" value="<?php echo set_value('gw') ?>">
                        ...
                        <div class="form-row row-fluid m-b-10">
                            ...
                            <div class="span6" id="4">
                                ...
                                <div class="span7">
                                    <input required="" class="payment_terms span12 text" type="text" name="payment_terms" id="payment_terms" value="<?php echo set_value('payment_terms') ?>">
                            ...
                            <div class="span6">
                                ...
                                <div class="span7">
                                    <input required="" oninput="this.value=this.value.replace(/[^0-9]/,'')" class="validity_days span12 text" type="text" name="validity_days" id="validity_days" value="<?php echo set_value('validity_days') ?>">
                        ...
                        <div class="form-row row-fluid m-b-10">
                            ...
                            <div class="span6" id="4">
                                ...
                                <div class="span7">
                                    <input required="" oninput="this.value=this.value.replace(/[^0-9]/,'')" class="delivery_cost span12 text" type="text" name="delivery_cost" id="delivery_cost" value="<?php echo set_value('delivery_cost') ?>">
                            ...
                            <div class="span6">
                                ...
                                <div class="span7">
                                    <input required="" oninput="this.value=this.value.replace(/[^0-9]/,'')" class="packing_cost span12 text" type="text" name="packing_cost" id="packing_cost" value="<?php echo set_value('packing_cost') ?>">
                        ...
                        <div class="form-row row-fluid m-b-10">
                            ...
                            <div class="span6" id="4">
                                ...
                                <div class="span7">
                                    <input required="" oninput="this.value=this.value.replace(/[^0-9]/,'')" class="warranty_month span12 text" type="text" name="warranty_month" id="warranty_month" value="<?php echo set_value('warranty_month') ?>">
