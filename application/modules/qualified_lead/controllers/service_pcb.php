...
class Service_Pcb extends MY_Controller {
    ...
    function __construct()
    {
        ...
        $this->data['base_url'] = base_url("qualified_lead/service_pcb");
        ...
        $this->data['module_link'] = base_url("qualified_lead/service_pcb")."/list_items";
	...
	{  
        ...
        foreach ($result['result'] as $row) { 
            if (!empty($row->display_id)) {
                $row->display_id = '<a href="'.base_url().'qualified_lead/service_pcb/view/'.$row->id.'">#'.$row->display_id.'</a>';//'#'.$v[$val['name']];
  ...
  // ------------------------------------------------------------------------
   ...
   /**
	...
	public function disqualified_form() {
	  ...
	  //pr($this->db->last_query());die;
	  return redirect(base_url("qualified_lead/service_pcb")."/list_items");
  }
