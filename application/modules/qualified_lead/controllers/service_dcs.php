...
class Service_Dcs extends MY_Controller {
    ...
    function __construct()
    {
        ...
        $this->data['base_url'] = base_url("qualified_lead/service_dcs");
        ...
        $this->data['module_link'] = base_url("qualified_lead/service_dcs")."/list_items";
  ...
  // ------------------------------------------------------------------------
     ...
     */
	 ...
	 return redirect(base_url("qualified_lead/service_dcs")."/view/".$_POST['lead_id']);
  }
   /**
	...
	public function disqualified_form() {
	  ...
	  //pr($this->db->last_query());die;
	  return redirect(base_url("qualified_lead/service_dcs")."/list_items");
  }
