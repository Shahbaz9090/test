...
class Service_Automation extends MY_Controller {
    ...
    function __construct()
    {
        ...
        $this->data['base_url'] = base_url("qualified_lead/service_automation");
        ...
        $this->data['module_link'] = base_url("qualified_lead/service_automation")."/list_items";
	...
	{  
        ...
        foreach ($result['result'] as $row) { 
            if (!empty($row->display_id)) {
                $row->display_id = '<a href="'.base_url().'qualified_lead/service_automation/view/'.$row->id.'">#'.$row->display_id.'</a>';//'#'.$v[$val['name']];
  ...
  // ------------------------------------------------------------------------
   ...
   public function get_company_all_data()
     ...
     */
	  ...
	  return redirect(base_url('qualified_lead/service_automation/view/'.$_POST['lead_id']));
  }
   /**
	...
	public function qualified_form() {
	  ...
	  //pr($this->db->last_query());die;
	  return redirect(base_url('qualified_lead/service_automation/list_items'));
  }
