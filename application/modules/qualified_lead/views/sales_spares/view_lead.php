								...
								<!--<div  class="user-profile">-->
										...
										<div class="span3">
											<!------------------------------Actions------------------------------------>
															...
															<div class="widget-main">
																<div class="row-fluid">
																	<div class="span12"  style="width:205px;">
																		...
																		<p>
																			<a class="btn btn-sm btn-success equal-width button_height" href="<?=base_url()?>qualified_lead/sales_spares/edit/<?=@$leads_ids;?>"><i class="ace-icon fa fa-pencil-square-o align-top bigger-125"></i> Edit</a>
																		</p>
																		<?php //} ?>
												...
												<?php //$note = _getDisqualifyNote(@$row->id); if($note){ ?>
