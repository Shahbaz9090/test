<div class="row">
<div class="col-sm-12"><?php //echo get_flashdata();?></div>
<div class="col-sm-12">
	<!--<div class="col-sm-6">
...
<script>
	...
	$("#submit").click(function(){
		...
		if(search == ''){
			...
			window.location.href = '<?= base_url() ?>lead/list_items?filter_by='+filter_by+'&search='+search+'&duration='+duration;
		}
	});
	$(".clear_search").click(function(){
		window.location.href = '<?= base_url() ?>lead/list_items';
	});
</script>