															...
															<div class="widget-main">
																<div class="row-fluid">
																	<div class="span12"  style="width:205px;">
																		...
																		<p>
																			<a class="btn btn-sm btn-success equal-width button_height" href="<?=base_url()?>qualified_lead/service_dcs/edit/<?=@$leads_ids;?>"><i class="ace-icon fa fa-pencil-square-o align-top bigger-125"></i> Edit</a>
																		</p>
																		<?php //} ?>
