...
class Sales_Spares_mod extends CI_Model {
   ...
   // public $table     = "companies";
    ...
    function add()
    {
      ...
      //  $this->form_validation->set_rules('country', lang('country'), 'trim|required');
       ...
       // $this->form_validation->set_rules('pincode', lang('pincode'), 'trim|required');
        //$this->form_validation->set_rules('website_address', lang('website_address'), 'trim|required');
    ...
    {  
		...
		$this->db->join('lead_notes as lnd','lnd.lead_id =lead.id','left');
		...
		$this->db->from("leads_sales_spares as lead");
    ...
    function ajax_list_items($text, $limit, $offset, $order_by='id', $order='desc',$user='') {
		...
		$this->db->where('leads_sales_spares.lead_status','2');
