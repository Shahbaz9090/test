                     ...
                     <div class="span6">
						<div class="row-fluid">
							<label class="form-label span4" for="normal"><?=lang('company_contact_person_previous_company')?></label>
							 <div class="row-fluid">
								<div class="span6 " style="width: 250px;margin-left: 7px;">  
								  <input type="text" value="<?php echo  @$result->previous_company; ?>" id="company_contact_person_previous_company" name="company_contact_person_previous_company" class="col-xs-10 col-sm-6 pull-right"   />
							 </div>
						   </div>
						</div>
					</div>
