...
class Sales_spares_database extends MY_Controller {
    ...
    public function __construct()
    {
        ...
        $this->load->library('enquiry_database_lib', [$this, 'Sales Spares Database List', 1] );
        ...
        $this->data['title'] 	        = "Sales Spares Database List";
        $this->data['readonly'] 		= NULL;
        $this->data['base_url'] 		= base_url("enquiry_database/sales_spares_database/");
        $this->data['module_url'] 		= base_url("enquiry_database/sales_spares_database/");
        $this->table_name   			= "enquiry_database";
	...
	{  
        ...
        // pr($this->data);die;
        $this->data['submodule'] = 'Sales Spares Database List';
    ...
    public function export($id='')
    {
        ...
        $filename = "Sales Spares Enquiry Database" . date('d-m-Y'). ".xls";
