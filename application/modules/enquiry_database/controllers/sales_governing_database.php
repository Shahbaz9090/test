...
class Sales_governing_database extends MY_Controller {
    ...
    public function __construct()
    {
        ...
        $this->load->library('enquiry_database_lib', [$this, 'Sales Governing Database List', 2] );
        ...
        $this->data['title'] 	        = "Sales Governing Database Enquiry";
        $this->data['readonly'] 		= NULL;
        $this->data['base_url'] 		= base_url("enquiry_database/sales_governing_database/");
        $this->data['module_url'] 		= base_url("enquiry_database/sales_governing_database/");
	...
	{  
	    ...
	    $views[] = "list";
        $this->data['title'] = 'Sales Governing Database List';
        ...
        //pr($this->data);die;
        $this->data['submodule'] = 'Sales Governing Database List';
    ...
    public function export($id='')
    {
        ...
        $filename = "Sales Governing Enquiry Database" . date('d-m-Y'). ".xls";
