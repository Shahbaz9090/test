                    ...
                    <div class="portlet-body" style="padding: 5px;">
                                    ...
                                    <select required="" name="hsn_code_india" id="hsn_code_india" class="span12 chosen-select nostyle">
                                        ...
                                        if(isset($hsncode_master_india) && !empty($hsncode_master_india))
                                        {
                                            foreach ($hsncode_master_india as $key => $hsncode) {?>
                                                ...
                                                <option <?php echo set_value('hsn_code_india') && $hsncode->hsn_name==set_value('hsn_code_india')?'selected':'' ?> value="<?php echo $hsncode->form_id?>"><?php echo $hsncode->hsn_name ?></option>
                                            <?php }
                                        }?>
                                    </select>
                        ...
                        <div class="form-row row-fluid m-b-10">
                            ...
                            <div class="span6">
                                ...
                                <div class="span7">
                                    <input required oninput="this.value=this.value.replace(/[^0-9]/,'')" class="qty span12 text" type="text" name="qty" id="qty" value="<?php echo set_value('qty') ?>" onkeyup="cal_unit_price()">
                        ...
                        <div class="form-row row-fluid m-b-10">
                            <div class="span6">
                                ...
                                <div class="span7">
                                    <select class="span12 nostyle chosen-select" name="supplier_country" id="supplier_country" required="">
                                        ...
                                        <option value="2">CFIT</option>
                                        <option value="3">CFIT & India</option>
                                    </select>
                            ...
                            <div class="span6">
                                ...
                                <div class="span7">
                                    <input autocomplete="off" required="" oninput="this.value=this.value.replace(/[^0-9]/,'')" onkeyup="cal_unit_price()" class="po_basic span12 text" type="text" name="po_basic" id="po_basic" value="<?php echo set_value('po_basic') ?>">
                        ...
                        <div class="form-row row-fluid m-b-10">
                            <div class="span6">
                                ...
                                <div class="span7">
                                    <input readonly="" required="" oninput="this.value=this.value.replace(/[^0-9]/,'')" class="po_tax_value span12 text" type="text" name="po_tax_value" id="po_tax_value" value="<?php echo set_value('po_tax_value') ?>">
                            ...
                            <div class="span6">
                                ...
                                <div class="span7">
                                    <input type="hidden" name="product_sequence" value="<?=isset($product_sequence) && !empty($product_sequence)?$product_sequence:0?>" >
                        ...
                        <div class="form-row row-fluid m-b-10">
                            <div class="span6">
                                ...
                                <div class="span7">
                                    <textarea  required="" type="text" name="inv_description" id="inv_description"class="span12 unique"><?php echo $product_list->inv_description ?><?php echo set_value('inv_description') ?></textarea>
