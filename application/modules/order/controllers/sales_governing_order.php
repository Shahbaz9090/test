...
/**
 * CodeIgniter sales_governing_order Controller
 *
 * @package		CodeIgniter
 * @subpackage	Controllers
 * @category	sales_governing_order
...
class Sales_governing_order extends MY_Controller {
    ...
    public function __construct()
    {
        ...
        $this->load->library('order_lib', [$this, 'Sales Governing Order List', 2] );
        $this->lang->load('order', get_site_language());
        $this->data['title'] 	        = "Sales Governing Order";
        $this->data['title_for_view']   = "Sales Governing";
        $this->data['sales_enquiry_url']= base_url('enquiry/sales_governing_enquiry_china');
        $this->data['readonly'] 		= NULL;
        $this->data['base_url'] 		= base_url("order/sales_governing_order/");
        $this->data['module_url'] 		= base_url("order/sales_governing_order/");
