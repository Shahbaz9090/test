				...
				<div class="content">
						...
						<div class="form-row row-fluid">
							...
							<div class="master-container overflow-box1">
								<table class="responsive table table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            <th style="background: transparent;">Invoice No.</th>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: left;"><?php echo $row->client_reference; ?></td>
                                            <th>Source</th>
                                            <td style="text-align: left;"><?php echo $row->source; ?></td>
                                        </tr>
                                        <tr>
                                            <th>Destination</th>
                                            <td style="text-align: left;"><?php echo $row->destination; ?></td>
                                            <th>Via</th>
                                            <td style="text-align: left;"><?php echo $row->via; ?></td>
                                           
                                        </tr>
                                        <tr>
                                            <th>Mode of Dispatch</th>
                                            <td style="text-align: left;"><?php echo $row->mode_of_dispatch; ?></td>
                                            <th>Terms of Delivery</th>
                                            <td style="text-align: left;"><?php echo $row->terms_of_delivery; ?></td>
                                        </tr>
                    ...
                    <div class="sub-division" id="product-info">
                        <div class="form-row row-fluid">
                            <div class="form-actions">
                                <h3>Product Info 
                                    <span class="pull-right "><a data-href="<?=$base_url?>/create_invoice/<?=$result->form_id?>" class="btn btn-xs btn-info create_invoice"><i class="ace-icon fa fa-check align-top bigger-125"></i> Create Invoice</a>&nbsp;&nbsp;&nbsp;</span>
                                    
                                    <span class="pull-right" style="margin-right: 10px;">
                                        <select id="po_no" class="nostyle" style="min-width: 100px;">
                                            <option value="">Select Type</option>
                                            <option value="1">Sales Spare</option>
                                            <option value="2">Sales Goverinig</option>
                                            <option value="3">Sales PCB</option>
                                        </select>
                                    </span>
                                </h3>
                            </div>
                            <div class="product-wrapper overflow-box">
                                <table class="table" style="min-width: 100%">
                                    ...
                                    <tbody class="tbody order_product_list">
                                        ...
                                        <tr class="product_1">
                                            <td>
                                                <input onchange="add_in_box(this,1,1,20,24.15,483.00,'ORD002')" type="checkbox" value="1" data-order-id="1" data-product-id="1" class="product_id_ckh">
                                            </td>
                                        ...
                                        <tr class="product_2">
                                            <td>
                                                <input onchange="add_in_box(this,2,1,10,0,0,'ORD002')" type="checkbox" value="1" data-order-id="1" data-product-id="2" class="is_product">
                                            </td>
                                        ...
                                        <tr class="product_3">
                                            <td>
                                                <input onchange="add_in_box(this,3,1,15,0,0,'ORD002')" type="checkbox" value="1" data-order-id="1" data-product-id="3" class="is_product">
                                            </td>
								...
								<div class="form-row row-fluid m-b-10">
		                            ...
		                            <div class="span6">
		                                <div class="document-wrapper">
		                                	<h4>India Document <span onclick="set_documement_type(1, 'India Document','<?=$result->form_id?>')" data-toggle="modal" data-target="#add_document_modal" style="padding: 2px" class="btn btn-xs pull-right"><i class="fa fa-plus">Add</i></span></h4>
                                    ...
                                    <div class="span6">
                                        <div class="document-wrapper">
                                            <h4>China Document <span onclick="set_documement_type(3, 'China Document','<?=$result->form_id?>')" data-toggle="modal" data-target="#add_document_modal" style="padding: 2px" class="btn btn-xs pull-right"><i class="fa fa-plus">Add</i></span></h4>
                                            <div class="document-list">
                                                <ul>
                                                    <?php 
                                                    if(isset($document_list) && !empty($document_list))
