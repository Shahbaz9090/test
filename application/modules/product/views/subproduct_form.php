                                        ...
                                        <div class="panel-body">
                                             <div class="row">
                                                  <div class="panel-width-50">
                                                    ...
                                                    <select name="facility_type" class="col-xs-10 col-sm-6 pull-right" required='required' onchange="ajaxProSer(this.value);">
                                                  ...
                                                  <div class="panel-width-50">
                                                    <label class="control-label no-padding-right col-sm-5" for="form-field-1"> Parent <em class="required_em">*</em></label>
                                                    <select name="p_id" id="parent" class="col-xs-10 col-sm-6 pull-right" required='required'>
                                                      <option value="">Select</option>
                                                      <?php $productList=_parentProducts(@$row->facility_type);
                                                            if($productList){ 
                                                            foreach($productList as $product){
                                                      ?> 
                                                      <option value="<?=$product->id;?>" <?php if(@$row->p_id==$product->id){?> selected="selected" <? } ?>><?=$product->name;?></option>
                                                      <?php } } ?>
                                                    </select>
                                                  </div>
                                              </div>
                                                ...
                                                <div class="widget-box widget-background">
                                                   ...
                                                   <div class="widget-body widget-background">
        										     <div class="panel-body">
                                                        ...
                                                        <!--<div class="row">
                                                          <div class="panel-width-50">
                                                            <label class="control-label no-padding-right col-sm-5" for="form-field-1"> Product Commission <em class="required_em">*</em></label>
                                                            <input type="text" value="<?php echo  @$row->commission; ?>" name="commission" class="col-xs-10 col-sm-6 pull-right" required='required'/>
                                                          </div>
                                                          <div class="panel-width-50">
                                                             <label class="control-label no-padding-right col-sm-5" for="form-field-1"> VAT(%) </label>
                                                             <input type="text" value="<?php echo  (isset($row->vat))?$row->vat:'4.50'; ?>" name="vat" class="col-xs-10 col-sm-6 pull-right" required='required'/>
                                                          </div>
                                                       </div>-->
                                                       <!--<div class="row">
                                                          <div class="panel-width-50">
                                                            <label class="control-label no-padding-right col-sm-5" for="form-field-1"> Sales(%) </label>
                                                            <input type="text" value="<?php echo  (isset($row->sales))?$row->vat:'10.50'; ; ?>" name="sales" class="col-xs-10 col-sm-6 pull-right" required='required'/>
                                                          </div>
                                                          <div class="panel-width-50">
                                                             <label class="control-label no-padding-right col-sm-5" for="form-field-1"> Service(%) </label>
                                                             <input type="text" value="<?php echo  (isset($row->service))?$row->service:'12.50'; ; ?>" name="service" class="col-xs-10 col-sm-6 pull-right" required='required'/>
                                                          </div>
                                                       </div>-->
                                                      </div>
            										</div>
...
<script>
function ajaxProSer(val){
    var str=token_name+'='+token_hash+'&facility_type='+val;
    $.post('<?=SITE_PATH?>product/ajaxProductService',str,function(data){
        $('#parent').html(data); 
    });    
}
</script>                        