...
class Service_Dcs extends MY_Controller {
    ...
    function __construct()
    {
        ...
        $this->data['base_url'] = base_url("lead/service_dcs");
        ...
        $this->data['module_link'] = base_url("lead/service_dcs")."/list_items";
       ...
       if(isPostBack())
       {
           $r = $this->service_dcs_mod->update($id);
            ...
            if($r){
                ...
                // $this->data['error_msg']="Oops !! This Vendor Code is Already Exists.";
			}
       }
	...
	{  
        ...
        foreach ($result['result'] as $row) { 
            if (!empty($row->display_id)) {
                $row->display_id = '<a href="'.base_url().'lead/service_dcs/view/'.$row->id.'">#'.$row->display_id.'</a>';//'#'.$v[$val['name']];
  ...
  // ------------------------------------------------------------------------
     ...
     */
	  ...
	  return redirect(base_url('lead/service_dcs/view/'.$_POST['lead_id']));
  }
   /**
	...
	public function qualified_form() {
	  ...
	  //pr($this->db->last_query());die;
	  return redirect(base_url('lead/service_dcs/list_items'));
  }
