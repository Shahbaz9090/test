...
.boxe{
	...
	text-align:justify;
			...
			<!----------------- VFD BLOCK START HEREE  --------------->	
				...
				<div class="form-row row-fluid">
				<?php foreach ($result->leads_sales_pcb_doc as $leads_sales_pcb_doc_key => $leads_sales_pcb_doc_value) { ?>
					<div class="span6">
						<div class="row-fluid">
							<label class="form-label span4" for="normal"><?=lang('doc_upload')?></label>
							 <div class="row-fluid">
								<div class="span6 "> 
								<?php if(!empty($leads_sales_pcb_doc_value->filename)){ ?>
								<p><?= ucwords($leads_sales_pcb_doc_value->filename); ?>
								<?php 
										if(isset($result->leads_sales_pcb_doc) && !empty($result->leads_sales_pcb_doc))
										{
												...
												<?php } else{?>
													<a download href="<?=base_url('upload/sales_pcb/'.$leads_sales_pcb_doc_value->filename)?>"><img style="height:20px;width:30px;padding-right:3px" src="<?=base_url('assets/images/file_icon.png')?>"/></a>
												<?php }
				...
				<?php if(!empty($result->lead_sales_pcb_others)) { 
				
				foreach($result->lead_sales_pcb_others as $val_lead_others){
				?>
				<div class="form-row row-fluid">
					<div class="span6">
						<div class="row-fluid">
						
							<label class="form-label span6" style="font-weight: 900;" for="normal"><?=lang('type_make_machine')?></label>
							  <div class="row-fluid">
							  <div class="span6 ">
								<?php if(isset($type_make_machine) && is_array($type_make_machine)){
                                                foreach($type_make_machine as $i_key => $i_val){
													if($val_lead_others->type_make_machine == $i_val->form_id){
														echo $i_val->name;
                                               } } ?>
                                <?php }else { ?>
								<p>-/-</p>
                    ...
                    <div class="span6">
						<div class="row-fluid">
							...
							<label class="form-label span6" style="font-weight: 900;" for="normal"><?=lang('make_model_controller')?></label>
							  <div class="row-fluid">
								<div class="span6 ">
								<?php if(isset($make_model_controller) && is_array($make_model_controller)){
                                                foreach($make_model_controller as $i_key => $i_val){
													if($val_lead_others->make_model_controller == $i_val->form_id){
														echo $i_val->name;
                                               } } ?>
                                <?php }else { ?>
								<p>-/-</p>
				...
				<div class="form-row row-fluid">
					<div class="span6">
						<div class="row-fluid">
							...
							<label class="form-label span6" style="font-weight: 900;" for="normal"><?=lang('no_machine')?></label>
							  <div class="row-fluid">
							  <div class="span6 ">
								<?php if(!empty($val_lead_others->no_machine)){?>
								<p><?=$val_lead_others->no_machine; ?></p>
                                <?php }else { ?>
								<p>-/-</p>
								 <?php } ?>
								</div>
                    ...
                    <div class="span6">
						<div class="row-fluid">
							...
							<label class="form-label span6" style="font-weight: 900;" for="normal"><?=lang('qty_controller')?></label>
							  <div class="row-fluid">
								<div class="span6 ">
								<?php if(!empty($val_lead_others->qty_controller)){?>
								<p><?=$val_lead_others->qty_controller; ?></p>
                                <?php }else { ?>
								<p>-/-</p>
								 <?php } ?>
								</div>
															...
															<div class="widget-main">
																<div class="row-fluid">
																	<div class="span12"  style="width:205px;">
																		...
																		<?php// pr($permission_all_user); //if($leadStatus=='2' || $leadStatus=='0'){?>
																		<?php  if(($userinfo->is_super==1) || $edit|| $permission_all_user['own_edit'] || $permission_all_user['all_edit']  ){ ?>
																		<p>
																			<a class="btn btn-sm btn-success equal-width button_height" href="<?=base_url()?>lead/sales_pcb/edit/<?=@$leads_ids;?>"><i class="ace-icon fa fa-pencil-square-o align-top bigger-125"></i> Edit</a>
																		</p>
																		<?php } ?>
