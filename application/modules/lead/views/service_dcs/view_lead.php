...
.boxe{
	margin:4px, 4px; 
			...
			<!----------------- VFD BLOCK START HEREE  --------------->	
				...
				<div class="form-row row-fluid">
				<?php foreach ($result->leads_service_dcs_doc as $leads_service_dcs_doc_key => $leads_service_dcs_doc_value) { ?>
					<div class="span6">
						<div class="row-fluid">
							<label class="form-label span4" for="normal"><?=lang('doc_upload')?></label>
							 <div class="row-fluid">
								<div class="span6 "> 
								<?php if(!empty($leads_service_dcs_doc_value->filename)){ ?>
								<p><?= ucwords($leads_service_dcs_doc_value->filename); ?>
								<?php 
										if(isset($result->leads_service_dcs_doc) && !empty($result->leads_service_dcs_doc))
										{
															...
															<div class="widget-main">
																<div class="row-fluid">
																	<div class="span12"  style="width:205px;">
																		...
																		<p>
																			<a class="btn btn-sm btn-success equal-width button_height" href="<?=base_url()?>lead/service_dcs/edit/<?=@$leads_ids;?>"><i class="ace-icon fa fa-pencil-square-o align-top bigger-125"></i> Edit</a>
																		</p>
																		<?php } ?>
