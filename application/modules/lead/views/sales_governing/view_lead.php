...
.boxe{
	margin:4px, 4px; 
			...
			<!----------------- VFD BLOCK START HEREE  --------------->	
				...
				<div class="form-row row-fluid">
				<?php foreach ($result->leads_sales_governing_doc as $leads_sales_governing_doc_key => $leads_sales_governing_doc_value) { ?>
					<div class="span6">
						<div class="row-fluid">
							<label class="form-label span4" for="normal"><?=lang('doc_upload')?></label>
							 <div class="row-fluid">
								<div class="span6 "> 
								<?php if(!empty($leads_sales_governing_doc_value->filename)){ ?>
								<p><?= ucwords($leads_sales_governing_doc_value->filename); ?>
								<?php 
										if(isset($result->leads_sales_governing_doc) && !empty($result->leads_sales_governing_doc))
										{
												...
												{ ?>
													<a download href="<?=base_url('upload/sales_governing/'.$leads_sales_governing_doc_value->filename)?>"><img style="height:20px;width:30px;padding-right:3px" src="<?=base_url('upload/sales_governing/'.$leads_sales_governing_doc_value->filename)?>"/></a>

												<?php } else{?>
													<a download href="<?=base_url('upload/sales_governing/'.$leads_sales_governing_doc_value->filename)?>"><img style="height:20px;width:30px;padding-right:3px" src="<?=base_url('assets/images/file_icon.png')?>"/></a>
												<?php }
				...
				<?php if(!empty($result->lead_gov_others)) { 
				
				foreach($result->lead_gov_others as $val_lead_others){
				?>
				<div class="form-row row-fluid">
					<div class="span6">
						<div class="row-fluid">
                    ...
                    <div class="span6">
						<div class="row-fluid">
							...
							<label class="form-label span6" style="font-weight: 900;" for="normal"><?=lang('vib_system_make_model')?></label>
							  <div class="row-fluid">
								<div class="span6 ">
								<?php if(isset($vib_system_make_model) && is_array($vib_system_make_model)){
                                                foreach($vib_system_make_model as $i_key => $i_val){
													if($val_lead_others->vib_system_make_model == $i_val->form_id){
														echo $i_val->name;
                                               } } ?>
                                <?php }else { ?>
								<p>-/-</p>
				...
				<div class="form-row row-fluid">
                    ...
                    <div class="span6">
						<div class="row-fluid">
							...
							<label class="form-label span6" style="font-weight: 900;" for="normal"><?=lang('ext_system_make_model')?></label>
							  <div class="row-fluid">
								<div class="span6 ">
								<?php if(isset($ext_system_make_model) && is_array($ext_system_make_model)){
                                                foreach($ext_system_make_model as $i_key => $i_val){
													if($val_lead_others->ext_system_make_model == $i_val->form_id){
														echo $i_val->name;
                                               } } ?>
                                <?php }else { ?>
								<p>-/-</p>
				...
				<div class="form-row row-fluid">
                    ...
                    <div class="span6">
						<div class="row-fluid">
							...
							<label class="form-label span6" style="font-weight: 900;" for="normal"><?=lang('elec_governor_make_model')?></label>
							  <div class="row-fluid">
								<div class="span6 ">
											<?php if(isset($elec_governor_make_model) && is_array($elec_governor_make_model)){
                                                foreach($elec_governor_make_model as $i_key => $i_val){
													if($val_lead_others->elec_governor_make_model == $i_val->form_id){
														echo $i_val->name;
                                               } } ?>
                                <?php }else { ?>
								<p>-/-</p>
				...
				<div class="form-row row-fluid">
                    ...
                    <div class="span6">
						<div class="row-fluid">
							...
							<label class="form-label span6" style="font-weight: 900;" for="normal"><?=lang('i_h_actuator_make_model')?></label>
							  <div class="row-fluid">
								<div class="span6 ">
								<?php if(isset($i_h_actuator_make_model) && is_array($i_h_actuator_make_model)){
                                                foreach($i_h_actuator_make_model as $i_key => $i_val){
													if($val_lead_others->i_h_actuator_make_model == $i_val->form_id){
														echo $i_val->name;
                                               } } ?>
                                <?php }else { ?>
								<p>-/-</p>
															...
															<div class="widget-main">
																<div class="row-fluid">
																	<div class="span12"  style="width:205px;">
																		<?php //pr($permission_all_user['own_edit']); //pr($leads_ids); //if($leadStatus=='2' || $leadStatus=='0'){?>
																		<?php  if(($userinfo->is_super==1) || $edit|| $permission_all_user['own_edit'] || $permission_all_user['all_edit']  ){ ?>
																		<p>
																			<a class="btn btn-sm btn-success equal-width button_height" href="<?=base_url()?>lead/sales_governing/edit/<?=@$leads_ids;?>"><i class="ace-icon fa fa-pencil-square-o align-top bigger-125"></i> Edit</a>
																		</p>
																		<?php } ?>
