...
$permission_all_user = $this->session->userdata("permission");
...
.boxe{
	margin:4px, 4px; 
			...
			<!----------------- VFD BLOCK START HEREE  --------------->	
				...
				<div class="form-row row-fluid">
				<?php foreach ($result->leads_sales_spares_doc as $leads_sales_spares_doc_key => $leads_sales_spares_doc_value) { ?>
					<div class="span6">
						<div class="row-fluid">
							<label class="form-label span4" for="normal"><?=lang('doc_upload')?></label>
							 <div class="row-fluid">
								<div class="span6 "> 
								<?php if(!empty($leads_sales_spares_doc_value->filename)){ ?>
								<p><?= ucwords($leads_sales_spares_doc_value->filename); ?>
								<?php 
										if(isset($result->leads_sales_spares_doc) && !empty($result->leads_sales_spares_doc))
										{
				...
				<?php if(!empty($result->lead_others)) { 
				
				foreach($result->lead_others as $val_lead_others){
					//pr($val_lead_others);die;
				?>
				<div class="form-row row-fluid">
					<div class="span6">
						<div class="row-fluid">
						
							<label class="form-label span6" style="font-weight: 900;" for="normal"><?=lang('no_of_unit')?></label>
							  <div class="row-fluid">
							  <div class="span6 ">
								<?php if(!empty($val_lead_others->no_of_unit)){?>
								<p><?=$val_lead_others->no_of_unit; ?></p>
                                <?php }else { ?>
								<p>-/-</p>
								 <?php } ?>
								</div>
                    ...
                    <div class="span6">
						<div class="row-fluid">
							...
							<label class="form-label span6" style="font-weight: 900;" for="normal"><?=lang('coal_mill_make')?></label>
							  <div class="row-fluid">
								<div class="span6 ">
								<?php if(isset($coal_mill_make) && is_array($coal_mill_make)){
                                                foreach($coal_mill_make as $i_key => $i_val){
													if($val_lead_others->coal_mill_make == $i_val->form_id){
														echo $i_val->name;
                                               } } ?>
                                <?php }else { ?>
								<p>-/-</p>
				...
				<div class="form-row row-fluid">
					<div class="span6">
						<div class="row-fluid">
							...
							<label class="form-label span6" style="font-weight: 900;" for="normal"><?=lang('capacity_of_unit')?></label>
							  <div class="row-fluid">
							  <div class="span6 ">
								<?php if(!empty($val_lead_others->capacity_of_unit)){?>
								<p><?=$val_lead_others->capacity_of_unit; ?></p>
                                <?php }else { ?>
								<p>-/-</p>
								 <?php } ?>
								</div>
                    ...
                    <div class="span6">
						<div class="row-fluid">
							...
							<label class="form-label span6" style="font-weight: 900;" for="normal"><?=lang('id_fan')?></label>
							  <div class="row-fluid">
								<div class="span6 ">
								<?php if(isset($id_fan) && is_array($id_fan)){
                                                foreach($id_fan as $i_key => $i_val){
													if($val_lead_others->id_fan == $i_val->form_id){
														echo $i_val->name;
                                               } } ?>
                                <?php }else { ?>
								<p>-/-</p>
				...
				<div class="form-row row-fluid">
					<div class="span6">
						<div class="row-fluid">
							...
							<label class="form-label span6" style="font-weight: 900;" for="normal"><?=lang('epc_company')?></label>
							  <div class="row-fluid">
							  	<div class="span6 ">
								<?php if(isset($epc_company) && is_array($epc_company)){
                                                foreach($epc_company as $i_key => $i_val){
													if($val_lead_others->epc_company == $i_val->form_id){
														echo $i_val->name;
                                               } } ?>
                                <?php }else { ?>
								<p>-/-</p>
                    ...
                    <div class="span6">
						<div class="row-fluid">
							...
							<label class="form-label span6" style="font-weight: 900;" for="normal"><?=lang('id_fan_motor_make')?></label>
							  <div class="row-fluid">
								<div class="span6 ">
								<?php if(isset($id_fan_motor_make) && is_array($id_fan_motor_make)){
                                                foreach($id_fan_motor_make as $i_key => $i_val){
													if($val_lead_others->id_fan_motor_make == $i_val->form_id){
														echo $i_val->name;
                                               } } ?>
                                <?php }else { ?>
								<p>-/-</p>
				...
				<div class="form-row row-fluid">
					<div class="span6">
						<div class="row-fluid">
							...
							<label class="form-label span6" style="font-weight: 900;" for="normal"><?=lang('cod_month_year')?></label>
							  <div class="row-fluid">
							  	<div class="span6 ">
								
								<?php if(!empty($val_lead_others->cod_month) && !empty($val_lead_others->cod_year)){?>
								<p><?=$val_lead_others->cod_month; ?>/<?=$val_lead_others->cod_year; ?></p>
                    ...
                    <div class="span6">
						<div class="row-fluid">
							...
							<label class="form-label span6" style="font-weight: 900;" for="normal"><?=lang('fd_fan')?></label>
							  <div class="row-fluid">
								<div class="span6 ">
								<?php if(isset($fd_fan) && is_array($fd_fan)){
                                                foreach($fd_fan as $i_key => $i_val){
													if($val_lead_others->fd_fan_make == $i_val->form_id){
														echo $i_val->name;
                                               } } ?>
                                <?php }else { ?>
								<p>-/-</p>
				...
				<div class="form-row row-fluid">
					<div class="span6">
						<div class="row-fluid">
							...
							<label class="form-label span6" style="font-weight: 900;" for="normal"><?=lang('boiler_make')?></label>
							  <div class="row-fluid">
							  	<div class="span6 ">
								<?php if(isset($boiler_make) && is_array($boiler_make)){
                                                foreach($boiler_make as $i_key => $i_val){
													if($val_lead_others->boiler_make == $i_val->form_id){
														echo $i_val->name;
                                               } } ?>
                                <?php }else { ?>
								<p>-/-</p>
                    ...
                    <div class="span6">
						<div class="row-fluid">
							...
							<label class="form-label span6" style="font-weight: 900;" for="normal"><?=lang('fd_fan_motor_make')?></label>
							  <div class="row-fluid">
								<div class="span6 ">
								<?php if(isset($fd_fan_motor_make) && is_array($fd_fan_motor_make)){
                                                foreach($fd_fan_motor_make as $i_key => $i_val){
													if($val_lead_others->fd_fan_motor_make == $i_val->form_id){
														echo $i_val->name;
                                               } } ?>
                                <?php }else { ?>
								<p>-/-</p>
				...
				<div class="form-row row-fluid">
					<div class="span6">
						<div class="row-fluid">
							...
							<label class="form-label span6" style="font-weight: 900;" for="normal"><?=lang('turbine_make')?></label>
							  <div class="row-fluid">
							  	<div class="span6 ">
								<?php if(isset($spares_turbine_make) && is_array($spares_turbine_make)){
                                                foreach($spares_turbine_make as $i_key => $i_val){
													if($val_lead_others->turbine_make == $i_val->form_id){
														echo $i_val->name;
                                               } } ?>
                                <?php }else { ?>
								<p>-/-</p>
                    ...
                    <div class="span6">
						<div class="row-fluid">
							...
							<label class="form-label span6" style="font-weight: 900;" for="normal"><?=lang('pa_fan')?></label>
							  <div class="row-fluid">
								<div class="span6 ">
								<?php if(isset($pa_fan) && is_array($pa_fan)){
                                                foreach($pa_fan as $i_key => $i_val){
													if($val_lead_others->pa_fan_make == $i_val->form_id){
														echo $i_val->name;
                                               } } ?>
                                <?php }else { ?>
								<p>-/-</p>
				...
				<div class="form-row row-fluid">
					<div class="span6">
						<div class="row-fluid">
							...
							<label class="form-label span6" style="font-weight: 900;" for="normal"><?=lang('generator_make')?></label>
							  <div class="row-fluid">
							  	<div class="span6 ">
								<?php if(isset($spares_generator_make) && is_array($spares_generator_make)){
                                                foreach($spares_generator_make as $i_key => $i_val){
													if($val_lead_others->generator_make == $i_val->form_id){
														echo $i_val->name;
                                               } } ?>
                                <?php }else { ?>
								<p>-/-</p>
                    ...
                    <div class="span6">
						<div class="row-fluid">
							...
							<label class="form-label span6" style="font-weight: 900;" for="normal"><?=lang('pa_fan_motor_make')?></label>
							  <div class="row-fluid">
								<div class="span6 ">
								<?php if(isset($pa_fan_motor_make) && is_array($pa_fan_motor_make)){
                                                foreach($pa_fan_motor_make as $i_key => $i_val){
													if($val_lead_others->pa_fan_motor_make == $i_val->form_id){
														echo $i_val->name;
                                               } } ?>
                                <?php }else { ?>
								<p>-/-</p>
				...
				<div class="form-row row-fluid">
					<div class="span6">
						<div class="row-fluid">
							...
							<label class="form-label span6" style="font-weight: 900;" for="normal"><?=lang('bfpt_make')?></label>
							  <div class="row-fluid">
							  	<div class="span6 ">
								<?php if(isset($bfpt_make) && is_array($bfpt_make)){
                                                foreach($bfpt_make as $i_key => $i_val){
													if($val_lead_others->bfpt_make == $i_val->form_id){
														echo $i_val->name;
                                               } } ?>
                                <?php }else { ?>
								<p>-/-</p>
                    ...
                    <div class="span6">
						<div class="row-fluid">
							...
							<label class="form-label span6" style="font-weight: 900;" for="normal"><?=lang('esp_make')?></label>
							  <div class="row-fluid">
								<div class="span6 ">
								<?php if(isset($esp_make) && is_array($esp_make)){
                                                foreach($esp_make as $i_key => $i_val){
													if($val_lead_others->esp_make == $i_val->form_id){
														echo $i_val->name;
                                               } } ?>
                                <?php }else { ?>
								<p>-/-</p>
				...
				<div class="form-row row-fluid">
					<div class="span6">
						<div class="row-fluid">
							...
							<label class="form-label span6" style="font-weight: 900;" for="normal"><?=lang('bfpm_make')?></label>
							  <div class="row-fluid">
							  	<div class="span6 ">
								<?php if(isset($bfpm_make) && is_array($bfpm_make)){
                                                foreach($bfpm_make as $i_key => $i_val){
													if($val_lead_others->bfpm_make == $i_val->form_id){
														echo $i_val->name;
                                               } } ?>
                                <?php }else { ?>
								<p>-/-</p>
                    ...
                    <div class="span6">
						<div class="row-fluid">
							...
							<label class="form-label span6" style="font-weight: 900;" for="normal"><?=lang('aph_make')?></label>
							  <div class="row-fluid">
								<div class="span6 ">
								<?php if(isset($aph_make) && is_array($aph_make)){
                                                foreach($aph_make as $i_key => $i_val){
													if($val_lead_others->aph_make == $i_val->form_id){
														echo $i_val->name;
                                               } } ?>
                                <?php }else { ?>
								<p>-/-</p>
				...
				<div class="form-row row-fluid">
					<div class="span6">
						<div class="row-fluid">
							...
							<label class="form-label span6" style="font-weight: 900;" for="normal"><?=lang('bfp_make')?></label>
							  <div class="row-fluid">
							  	<div class="span6 ">
								<?php if(isset($bfp_make) && is_array($bfp_make)){
                                                foreach($bfp_make as $i_key => $i_val){
													if($val_lead_others->bfp_make == $i_val->form_id){
														echo $i_val->name;
                                               } } ?>
                                <?php }else { ?>
								<p>-/-</p>
                    ...
                    <div class="span6">
						<div class="row-fluid">
							...
							<label class="form-label span6" style="font-weight: 900;" for="normal"><?=lang('vibration_system')?></label>
							  <div class="row-fluid">
								<div class="span6 ">
								<?php if(isset($vibration_system) && is_array($vibration_system)){
                                                foreach($vibration_system as $i_key => $i_val){
													if($val_lead_others->vibration_system == $i_val->form_id){
														echo $i_val->name;
                                               } } ?>
                                <?php }else { ?>
								<p>-/-</p>
				...
				<div class="form-row row-fluid">
					<div class="span6">
						<div class="row-fluid">
							...
							<label class="form-label span6" style="font-weight: 900;" for="normal"><?=lang('bfbp_make')?></label>
							  <div class="row-fluid">
							  	<div class="span6 ">
								<?php if(isset($bfbp_make) && is_array($bfbp_make)){
                                                foreach($bfbp_make as $i_key => $i_val){
													if($val_lead_others->bfbp_make == $i_val->form_id){
														echo $i_val->name;
                                               } } ?>
                                <?php }else { ?>
								<p>-/-</p>
                    ...
                    <div class="span6">
						<div class="row-fluid">
							...
							<label class="form-label span6" style="font-weight: 900;" for="normal"><?=lang('btld_make')?></label>
							  <div class="row-fluid">
								<div class="span6 ">
								<?php if(isset($btld_make) && is_array($btld_make)){
                                                foreach($btld_make as $i_key => $i_val){
													if($val_lead_others->btld_make == $i_val->form_id){
														echo $i_val->name;
                                               } } ?>
                                <?php }else { ?>
								<p>-/-</p>
				...
				<div class="form-row row-fluid">
					<div class="span6">
						<div class="row-fluid">
							...
							<label class="form-label span6" style="font-weight: 900;" for="normal"><?=lang('cep_make')?></label>
							  <div class="row-fluid">
							  	<div class="span6 ">
								<?php if(isset($cep_make) && is_array($cep_make)){
                                                foreach($cep_make as $i_key => $i_val){
													if($val_lead_others->cep_make == $i_val->form_id){
														echo $i_val->name;
                                               } } ?>
                                <?php }else { ?>
								<p>-/-</p>
                    ...
                    <div class="span6">
						<div class="row-fluid">
							...
							<label class="form-label span6" style="font-weight: 900;" for="normal"><?=lang('coal_feeder_make')?></label>
							  <div class="row-fluid">
								<div class="span6 ">
								<?php if(isset($coal_feeder_make) && is_array($coal_feeder_make)){
                                                foreach($coal_feeder_make as $i_key => $i_val){
													if($val_lead_others->coal_feeder_make == $i_val->form_id){
														echo $i_val->name;
                                               } } ?>
                                <?php }else { ?>
								<p>-/-</p>
				...
				<div class="form-row row-fluid">
					<div class="span6">
						<div class="row-fluid">
							...
							<label class="form-label span6" style="font-weight: 900;" for="normal"><?=lang('cep_motor_make')?></label>
							  <div class="row-fluid">
							  	<div class="span6 ">
								<?php if(isset($cep_motor_make) && is_array($cep_motor_make)){
                                                foreach($cep_motor_make as $i_key => $i_val){
													if($val_lead_others->cep_motor_make == $i_val->form_id){
														echo $i_val->name;
                                               } } ?>
                                <?php }else { ?>
								<p>-/-</p>
                    ...
                    <div class="span6">
						<div class="row-fluid">
							...
							<label class="form-label span6" style="font-weight: 900;" for="normal"><?=lang('flame_scanner_make')?></label>
							  <div class="row-fluid">
								<div class="span6 ">
								<?php if(isset($flame_scanner_make) && is_array($flame_scanner_make)){
                                                foreach($flame_scanner_make as $i_key => $i_val){
													if($val_lead_others->flame_scanner_make == $i_val->form_id){
														echo $i_val->name;
                                               } } ?>
                                <?php }else { ?>
								<p>-/-</p>
															...
															<div class="widget-main">
																<div class="row-fluid">
																	<div class="span12"  style="width:205px;">
																		...
																		<?php  if(($userinfo->is_super==1) || $edit|| $permission_all_user['own_edit'] || $permission_all_user['all_edit']  ){ ?>
																		<p>
																			<a class="btn btn-sm btn-success equal-width button_height" href="<?=base_url()?>lead/sales_spares/edit/<?=@$leads_ids;?>"><i class="ace-icon fa fa-pencil-square-o align-top bigger-125"></i> Edit</a>
																		</p>
																		<?php } ?>
															  ...
															  <div class="modal-dialog modal-sm">
																<div class="modal-content">
																  ...
																  <div class="modal-body">
																	<div class="row-fluid">
																	  <div class="span12">
																		<?php echo form_open("lead/$main/qualified_form",array('class'=>'form-horizontal','role'=>'form','id'=>'qualified_form'));?>
															  ...
															  <div class="modal-dialog modal-sm">
																<div class="modal-content">
																  ...
																  <div class="modal-body">
																	<div class="row-fluid">
																	  <div class="span12">
																		<?php echo form_open("lead/$main/disqualified_form",array('class'=>'form-horizontal','role'=>'form','id'=>'disqualified_form'));?>
																		<div class="span12" style="width:640px;">
																		<input type="hidden" name="lead_id" value="<?=@$result->main_id?>"/>
																		  <div class="row-fluid"> 
															  ...
															  <div class="modal-dialog modal-sm">
																<div class="modal-content">
																  ...
																  <div class="modal-body">
																	<div class="row-fluid">
																	  <div class="span12">
																		<?php echo form_open("lead/$main/addproduct",array('class'=>'form-horizontal','role'=>'form','id'=>'addproduct'));?>
																		<div class="span12" style="width:640px;">
																		<input type="hidden" name="lead_id" value="<?=@$result->main_id?>"/>
																		  <div class="row-fluid"> 
															  ...
															  <div class="modal-dialog modal-sm">
																<div class="modal-content">
																  ...
																  <div class="modal-body">
																	<div class="row-fluid">
																	  <div class="span12">
																		<?php echo form_open("lead/$main/addservice",array('class'=>'form-horizontal','role'=>'form','id'=>'addservice'));?>
																		<div class="span12" style="width:640px;">
																		<input type="hidden" name="lead_id" value="<?=@$result->main_id?>"/>
																		  <div class="row-fluid"> 
															  ...
															  <div class="modal-dialog modal-sm">
																<div class="modal-content">
																  ...
																  <div class="modal-body">
																	<div class="row-fluid">
																	  <div class="span12">
																		<?php echo form_open("lead/$main/assignopportunity",array('class'=>'form-horizontal','role'=>'form','id'=>'addservice'));?>
																		<div class="span12" style="width:640px;">
																		<input type="hidden" name="lead_id" value="<?=@$result->main_id?>"/>
																		  <div class="row-fluid"> 
																		   ...
																		   <div class="span12"></div>
																		   <div class="span12">   
																			  <button id="submit_note" class="btn btn-primary pull-right">Assign Opporunity</button>
																		   </div>
