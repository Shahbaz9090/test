							...
							<label class="form-label span4" for="normal"><?=lang('name')?><em>*</em></label>
							  <div class="row-fluid">
								...
								<input name="company_name" type="<?= ($this->uri->segment(2) == 'add')?"text":"hidden" ?>" class="col-xs-10 col-sm-6 pull-right" id="" value="<?php if(isset($company_id)){echo $company_id;}else if(@$row->company_name){ echo $row->company_name;}?>"/>
								 <input name="company_text" type="<?= ($this->uri->segment(2) == 'add')?"hidden":"text" ?>" id="company_text" class="col-xs-10 col-sm-6 pull-right" value="<?php echo $company_text ?>" autocomplete="off"   />
								...
								<div class="span6 select_style_margin-left"> 
								  <select name="industry" class="nostyle chosen-select" data-placeholder="Select..." id="industry">
									<option disabled value="">Select</option>
                                               ...
                                               ?>
                                               <option disabled="" value="<?=$i_val->id;?>" <?= ($row->comp_industry == $i_val->id)?"selected='selected'":"" ?>><?=$i_val->name; ?></option>
                                               <?php } }?>
							...
							<label class="form-label span4" for="normal"><?=lang('company_address')?></label>
							 <div class="row-fluid">
								<div class="span6 " style="width: 250px;">  
								  	...
								  	<textarea readonly name="company_address" id="company_address" class="col-xs-10 col-sm-6 pull-right"  ><?= $row->company_address;?></textarea>
							  ...
							  <div class="row-fluid">
								...
								<select name="type_of_establishment" class="nostyle chosen-select"   id="type_of_establishment">
									...
									<?php if(isset($client_type_establishment) && is_array($client_type_establishment)){
                                               ...
                                               ?>
                                               <option disabled value="<?=$i_val->form_id;?>" <?= ($row->type_of_establishment == $i_val->form_id)?"selected='selected'":"" ?>><?=$i_val->name; ?></option>
                                               <?php } }?>
																	</select>
								...
								<select name="country" class="nostyle chosen-select" onChange="fetch_state(this.value);"  id="country">
									<option disabled value="">Select</option>
									 <?php if(isset($country) && is_array($country)){
                                               ...
                                               ?>
                                               <option disabled value="<?=$i_val->id;?>" <?= ($row->country == $i_val->id)?"selected='selected'":"" ?>><?=$i_val->country_name; ?></option>
                                               <?php } }?>
								</select>
						...
						<div class="row-fluid">
							<label class="form-label span4" for="normal"><?=lang('city_code')?><em>*</em></label>
							  <div class="row-fluid">
								...
								<input readonly type="text" id="city_code" value="<?php echo  @$row->city_code; ?>" name="city_code" class="col-xs-10 col-sm-6 pull-right" />
								</div>
							 </div>
						</div>
					</div>
								...
								<select name="state_comp" class="nostyle chosen-select" id="state_comp" onChange="fetch_city(this.value);">
									...
									<option disabled value="">Select</option>
									 <?php if(isset($state) && is_array($state)){
                                               ...
                                               ?>
                                               <option disabled value="<?=$i_val->id;?>" <?= ($row->state_comp == $i_val->id)?"selected='selected'":"" ?>><?=$i_val->state_name; ?></option>
                                               <?php } }?>
																	</select>
						...
						<div class="row-fluid">
							<label class="form-label span4" for="normal"><?=lang('landline')?></label>
							  <div class="row-fluid">
								...
								<input readonly type="text" id="landline" value="<?php echo  @$row->landline; ?>" name="landline" class="col-xs-10 col-sm-6 pull-right" />
								</div>
							 </div>
						</div>
					</div>
							  ...
							  <div class="row-fluid">
								...
								<select name="city_comp" class="nostyle chosen-select"  id="city_comp">
									...
									<?php if(isset($city) && is_array($city)){
                                               ...
                                               ?>
                                               <option disabled value="<?=$i_val->id;?>" <?= ($row->city_comp == $i_val->id)?"selected='selected'":"" ?>><?=$i_val->city_name; ?></option>
                                               <?php } }?>
																	</select>
							  ...
							  <div class="row-fluid">
								...
								<select name="type_of_client" class="nostyle chosen-select"   id="type_of_client">
									...
									<?php if(isset($type_of_client) && is_array($type_of_client)){
                                               ...
                                               ?>
                                               <option disabled value="<?=$i_val->form_id;?>" <?= ($row->type_of_client == $i_val->form_id)?"selected='selected'":"" ?>><?=$i_val->name; ?></option>
                                               <?php } }?>
																	</select>
						...
						<div class="row-fluid">
							<label class="form-label span4" for="normal"><?=lang('pincode')?><em>*</em></label>
							  <div class="row-fluid">
								...
								<input readonly type="text" id="pincode" value="<?php echo  @$row->pincode; ?>" name="pincode" class="col-xs-10 col-sm-6 pull-right" />
							  ...
							  <div class="row-fluid">
								...
								<!--<select name="plant_established_year" class="nostyle" >
									<option value="">Select</option>
																	...
																	<input readonly type="text" id="plant_established_year" value="<?php echo  @$row->plant_established_year; ?>" name="plant_established_year" class="col-xs-10 col-sm-6 pull-right" />
								</div>
							 </div>
						</div>
					</div>
						...
						<div class="row-fluid">
							<label class="form-label span4" for="normal"><?=lang('cordinates')?></label>
							  <div class="row-fluid">
								...
								<input readonly type="text" id="cordinates" value="<?php echo  @$row->cordinates; ?>" name="cordinates" class="col-xs-10 col-sm-6 pull-right" />
								</div>
							 </div>
						</div>
					</div>
						...
						<div class="row-fluid">
							<label class="form-label span4" for="normal"><?=lang('website_address')?><em>*</em></label>
							  <div class="row-fluid">
								...
								<input readonly type="text" id="website_address" value="<?php echo  @$row->website; ?>" name="website_address" class="col-xs-10 col-sm-6 pull-right" />
								</div>
							 </div>
						</div>
					</div>
                    ...
                    <div class="span6">
						<div class="row-fluid">
							<label class="form-label span4" for="normal"><?=lang('pan')?></label>
							 <div class="row-fluid">
								<div class="span6 ">  
								  <input readonly type="text" value="<?php echo  @$row->tax_pan; ?>" id="pan" name="pan" class="col-xs-10 col-sm-6 pull-right"  />
							...
							<label class="form-label span4" for="normal"><?=lang('cin')?><em>*</em></label>
							  <div class="row-fluid">
								<div class="span6 ">
								 ...
								 <input readonly type="text" value="<?php echo  @$row->tax_cin; ?>" id="cin" name="cin" class="col-xs-10 col-sm-6 pull-right"  />
				  ...
				  <div class="span6">
						<div class="row-fluid">
							<label class="form-label span4" for="normal"><?=lang('gst')?></label>
							 <div class="row-fluid">
								<div class="span6 ">  
								  <input readonly type="text" value="<?php echo  @$row->tax_gst; ?>" id="gst" name="gst" class="col-xs-10 col-sm-6 pull-right"  />
							...
							<label class="form-label span4" for="normal"><?=lang('tan')?><em>*</em></label>
							  <div class="row-fluid">
								<div class="span6 ">
								 ...
								 <input readonly type="text" value="<?php echo  @$row->tax_tan; ?>" id="tan" name="tan" class="col-xs-10 col-sm-6 pull-right"  />
