			...
			<div class="content">
				...
				<div class="form-row row-fluid">
					<div class="span6">
						<div class="row-fluid">
							<div class="span4">
								<label class="form-label " for="normal"><?=lang('country')?><em>*</em></label>
							</div>
							<div class="span4">
								<input <?= ($result->country == "1" || $country=='1')?"checked":"" ?> class="" type="radio" name="country" value="1" > India
								<input <?= ($result->country == "2" || $country=='2')?"checked":"" ?> class="" type="radio" name="country" value="2" > China
							</div>
