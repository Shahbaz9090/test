                    ...
                    <div class="portlet-body" style="padding: 5px;">
                        ...
                        <div class="form-row row-fluid m-b-10">
                                ...
                                <div class="span7">
                                    <select name="issuer" id="issuer" class="span12 chosen-select nostyle">
                                        ...
                                        <?php foreach($employee_list as $employee):?>
                                            <option value="<?=$employee->id?>" <?=$employee->id == $in_out_detail->issuer?'selected':''?>><?=$employee->first_name.' '.$employee->last_name?></option>
                                        <?php endforeach;?>
                                        <?php endif;?>
                                    </select>
                            ...
                            <div class="span6">
                                ...
                                <div class="span7">
                                    <input type="text" name="purpose" class="purpose" value="<?=$in_out_detail->purpose?>">
                        ...
                        <div class="form-row row-fluid m-b-10">
                            <div class="span6">
                                ...
                                <div class="span7">
                                    <input type="text" name="out_date" class="out_date timepicker" readonly style="width: 98%;" value="<?=date('m/d/Y h:i A',strtotime($in_out_detail->out_date))?>">
                            ...
                            <div class="span6">
                                ...
                                <div class="span7">
                                    <input type="text" name="in_date" class="in_date timepicker" readonly value="<?=date('m/d/Y h:i A',strtotime($in_out_detail->in_date))?>">
                        ...
                        <div class="form-row row-fluid m-b-10">
                            <div class="span6">
                                ...
                                <div class="span7">
                                     <textarea  required="" type="text" name="remarks" id="remarks"class="span12 unique"><?php echo $in_out_detail->remarks ?></textarea>
