                                    ...
                                    <?php } else if($iterat_arr[$k]->type == 'select'){
                                        ...
                                        if(isset($iterat_arr[$k]->option_type) && $iterat_arr[$k]->option_type=='table')
                                        {
                                            ...
                                            <div class="span6 field-block" id ="<?=$key?>">
                                                ...
                                                <div class="span7">
                                                    <select <?=isset($iterat_arr[$k]->required) && $iterat_arr[$k]->required == 'true'?'required':''?> name="<?php echo $iterat_arr[$k]->name ?>" id="<?php echo $iterat_arr[$k]->name ?>" class="span12 nostyle chosen-select <?php echo $iterat_arr[$k]->name ?>">
                                                        <option value="">Select <?php echo ucwords($iterat_arr[$k]->label) ?></option>
                                                        <?php
                                                        if(isset($options) && !empty($options)){
                                                            foreach($options as $option){ 
                                                            $option_arr = (array) $option;?>
                                                            <option value="<?php echo $option_arr[$value_name]; ?>" ><?php echo ucwords($option_arr[$label_name]); ?></option>
                                                        <?php }} ?>
                                                    </select>
                                                    <div class="error" id="error_field_label"><?php echo form_error('field_label');?></div>
                                                </div>
                                        ...
                                        {?>
                                            <div class="span6 field-block" id ="<?=$key?>">
                                                ...
                                                <div class="span7">
                                                    <select <?=isset($iterat_arr[$k]->required) && $iterat_arr[$k]->required == 'true'?'required':''?> name="<?php echo $iterat_arr[$k]->name ?>" id="<?php echo $iterat_arr[$k]->name ?>" class="span12 nostyle chosen-select1 <?php echo $iterat_arr[$k]->name ?>">
                                                        <option value="">Select <?php echo ucwords($iterat_arr[$k]->label) ?></option>
                                                    </select>
                                                    <div class="error" id="error_field_label"><?php echo form_error('field_label');?></div>
                                                </div>
...
$(document).ready(function(){
    ...
    $('#enq_no').change(function(){
        check_enq_no();
    });
// do not load for modal 
<?php if(!isset($is_modal_view) && !$is_modal_view && 0):?>
    ...
    $("form").submit(function() { 
        ...
        if(error == true){
            ...
            $('.submit_btn').prop('disabled', true);//disable it for multiple add stop
        }
    });
<?php endif;?>
});  
