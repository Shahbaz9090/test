...
$(function() {
    ...
    var loginbuttonbox = $('#loginBox');
    var loginbuttonform = $('#loginForm');
    button.removeAttr('href');
    button.mouseup(function(login) {
        loginbuttonbox.toggle();
        loginbutton.toggleClass('active');
    });
    loginbuttonform.mouseup(function() { 
        return false;
    });
...
$(function() {
    ...
    logoutbutton.removeAttr('href');
    logoutbutton.mouseup(function(login) {
        logoutbox.toggle();
		$('#forgetBox').hide();
        logoutbutton.toggleClass('active');
    });
    logoutform.mouseup(function() { 
        return false;
    });
    $(this).mouseup(function(login) {
