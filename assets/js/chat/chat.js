...
function chatWith(chatuser,chatUserId) {	
	createChatBox(chatuser,'',chatUserId);	
...
function createChatBox(chatboxtitle,minimizeChatBox,chatUserId) {	
	...
	.addClass("chatbox")
	//.html('<div class="chatboxhead"><img src="http://localhost/astrology/public/images/admin/active.png"><div class="chatboxtitle">'+chatboxtitle+'</div><div class="chatboxoptions"><a href="javascript:void(0)" onclick="javascript:toggleChatBoxGrowth(\''+chatboxtitle+'\')">-</a> <a href="javascript:void(0)" onclick="javascript:closeChatBox(\''+chatboxtitle+'\')">X</a></div><br clear="all"/></div><div class="chatboxcontent"></div><div class="chatboxinput"><textarea class="chatboxtextarea" onkeydown="javascript:return checkChatBoxInputKey(event,this,\''+chatboxtitle+'\');"></textarea></div>')
	.html('<div class="chatboxhead"><div class="chatboxtitle">'+chatboxtitle+'</div><div class="chatboxoptions"><a href="javascript:void(0)" onclick="javascript:toggleChatBoxGrowth(\''+chatboxtitle+'\')">-</a> <a href="javascript:void(0)" onclick="javascript:closeChatBox(\''+chatboxtitle+'\')">X</a></div><br clear="all"/></div><div class="chatboxcontent"></div><div class="chatboxinput"><textarea class="chatboxtextarea" onkeydown="javascript:return checkChatBoxInputKey(event,this,\''+chatboxtitle+'\',\''+chatUserId+'\');"></textarea></div>')
...
function chatHeartbeat(){	
	...
	jQuery.ajax({
	  url: baseurl+"chat/chats/chatHeartbeat",
	  cache: false,
	  dataType: "json",
...
function closeChatBox(chatboxtitle) {
	...
	jQuery.post(baseurl+"chat/chats/closechat", { chatbox: chatboxtitle} , function(data){	
	});
...
function checkChatBoxInputKey(event,chatboxtextarea,chatboxtitle,chatUserId){	 
	if(event.keyCode == 13 && event.shiftKey == 0){
		...
		if (message != '') {
			...
			jQuery.post(baseurl+"chat/chats/sendchat", {to_id: chatUserId, to: chatboxtitle, message: message} , function(data){				
...
function startChatSession(){        
	jQuery.ajax({
	  url: baseurl+"chat/chats/startChatSession",
	  cache: false,
	  dataType: "json",
	  success: function(data){
