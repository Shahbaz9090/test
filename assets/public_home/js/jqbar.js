        ...
        jqbar: function (options) {
            ...
            return this.each(function () {
                ...
                if (settings.orientation == 'h') {
                    ...
                    progressContainer.addClass('jqbar horizontal').append('<span class="bar-label"></span><span class="progress-bg"><span class="bar-level-wrapper"><span class="bar-level"><span class="bar-percent"></span></span></span></span>');
