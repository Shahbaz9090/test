      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <h3 class="form-actions-title"><?php echo $form_title ?></h3>
              ...
              <div class="tile-body">
                <form method="post" action="<?=base_url($controller.'/edit/'.$form_id)?>" enctype="multipart/form-data">
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                            <label class="control-label">Form Name <em>*</em></label>
                            <div class="elem-group">
                              <input oninput="this.value=this.value.replace(/[^a-z0-9_]/,'')" class="form-control" autocomplete="off" type="text" name="form_name" value="<?=!empty(set_value('form_name')) ?set_value('form_name'):$result->form_name?>">
                            </div>
                        </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="elem-group">
                              <input class="form-control" autocomplete="off" type="text" name="form_label" value="<?=!empty(set_value('form_label')) ?set_value('form_label'):$result->form_label?>">
                            </div>
                        </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="elem-group">
                              <input class="form-control" autocomplete="off" type="text" name="email" value="<?=!empty(set_value('email')) ?set_value('email'):$result->email?>">
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="elem-group">
                              <select name="status" class="form-control chosen-select">
                                <option <?php echo isset($result->status) && $result->status==1?'selected':'' ?> value="1">Active</option>
                                <option <?php echo isset($result->status) && $result->status==2?'selected':'' ?> value="2">Inactive</option>
                              </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="elem-group">
                              <div class="animated-radio-button">
                                <label>
                                <input <?= @$result->view_on_left==1?'checked':''?> type="radio" name="view_on_left" value="1">
                                <span class="label-text">Active</span>
                              </label>
                              <label>
                               <input <?= @$result->view_on_left==0?'checked':''?> type="radio" name="view_on_left" value="0">
