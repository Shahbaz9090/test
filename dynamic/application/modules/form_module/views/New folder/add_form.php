								  	...
								  	<div class="row-fluid">
										<div class="span6 ">
											...
											{?>
											 	...
											 	<textarea name="<?php echo $iterat_arr[$k]->name ?>" id="field_label" rows="<?php echo $iterat_arr[$k]->rows ?>" value="" class="col-xs-10 col-sm-6 pull-right <?=$class_name_dynamic_unq;?>"></textarea>
											<?php } else{ ?>
											<input type="text" name="<?php echo $iterat_arr[$k]->name ?>" id="field_label" value="" class="col-xs-10 col-sm-6 pull-right <?=$class_name_dynamic_unq;?> " <?=$class_name_dynamic;?> >
				                          	<?php } ?>
									...
									<label for="age" class="form-label span4"><?php echo $iterat_arr[$k]->label ?></label>
								  	<div class="row-fluid">
										<div class="span6 ">
											...
											<input type="password" name="<?php echo $iterat_arr[$k]->name ?>" id="field_label" value="" class="col-xs-10 col-sm-6 pull-right <?=$class_name_dynamic_unq;?> " <?=$class_name_dynamic;?> >
								...
								<div class="row-fluid">
								 	...
								 	<div class="row-fluid">
										<div class="span6 ">
											...
											<input type="file" name="<?php echo $cols->name ?>" id="field_label" value="" class="col-xs-10 col-sm-6 pull-right" >
								...
								<div class="row-fluid">
									...
									<div class="span6 select_style_margin-left" style="margin-top:5px;">
										...
										foreach ($option as $option_key => $option_value) {?>
									        <div class="checker">
									            <span class="checked">
									                <input type="<?php echo $option_value->type ?>" id="radio5" name="<?=$option_value->name?>" value="<?=$option_value->value?>" style="opacity: 0;">
									            </span>
					 	...
					 	<?php } else if($iterat_arr[$k]->type == 'calendar'){ ?>
							...
							<div class="span6" id ="<?=$key?>">
								<div class="row-fluid">
								 	...
								 	<div class="row-fluid">
										<div class="span6 ">
											<input class="form-control calendarDate" type="text" name="<?php  echo $iterat_arr[$k]->name ?>" id="<?php echo $iterat_arr[$k]->name ?>" value="<?php echo $result[$cols->name]; ?>">
											<div class="error" id="error_field_label"><?php echo form_error('field_label');?></div>
										</div>
								 	</div>
								</div>
