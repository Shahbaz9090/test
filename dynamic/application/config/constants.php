...
defined('MAINSITE_MADMIN_URL') OR define('MAINSITE_MADMIN_URL', 'http://localhost/inch-erp/dynamic/');
defined('MAINSITE_FILE_PATH')  OR define('MAINSITE_FILE_PATH', "E:/system/xampp/htdocs/inch-erp/dynamic");
